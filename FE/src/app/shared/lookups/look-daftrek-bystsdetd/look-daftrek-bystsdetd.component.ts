...
@Component({
  selector: 'app-look-daftrek-bystsdetd',
  templateUrl: './look-daftrek-bystsdetd.component.html',
  styleUrls: ['./look-daftrek-bystsdetd.component.scss']
})
export class LookDaftrekBystsdetdComponent implements OnInit {
  ...
  gets(event: LazyLoadEvent){
    ...
    this.service.getByStsdetd(this.Idunit, this.Idbend, this.Idxkode, this.Kdstatus).subscribe(resp => {
