...
@Component({
  selector: 'app-look-sts-for-bku-bud',
  templateUrl: './look-sts-for-bku-bud.component.html',
  styleUrls: ['./look-sts-for-bku-bud.component.scss']
})
export class LookStsForBkuBudComponent implements OnInit {
  ...
  gets(event: LazyLoadEvent){
    ...
    this.service.getForBkud(this.Idunit, this.Kdstatus, this.Idxkode, this.Idbend).subscribe(resp => {
