...
@Component({
  selector: 'app-look-dpad-by-skpdet',
  templateUrl: './look-dpad-by-skpdet.component.html',
  styleUrls: ['./look-dpad-by-skpdet.component.scss']
})
export class LookDpadBySkpdetComponent implements OnInit {
  showThis: boolean;
  title: string;
  msg: Message[];
  loading: boolean;
  ...
  gets(Idunit: number, Idskp: number){
    this.loading = true;
    this.listdata = [];
    this.service._idunit = Idunit;
    this.service._idskp = Idskp;
