...
@Component({
  selector: 'app-look-daftrek-for-rkab-checkbox',
  templateUrl: './look-daftrek-for-rkab-checkbox.component.html',
  styleUrls: ['./look-daftrek-for-rkab-checkbox.component.scss']
})
export class LookDaftrekForRkabCheckboxComponent implements OnInit {
  ...
  gets(event: LazyLoadEvent){
    ...
    this.service._trkr = this.Trkr;
    this.service._kdtahap = this.Kdtahap;
    this.service.getForRkab().subscribe(resp => {
