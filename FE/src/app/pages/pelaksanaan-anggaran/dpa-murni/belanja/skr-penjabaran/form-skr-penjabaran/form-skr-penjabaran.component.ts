...
@Component({
  selector: 'app-form-skr-penjabaran',
  templateUrl: './form-skr-penjabaran.component.html',
  styleUrls: ['./form-skr-penjabaran.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormSkrPenjabaranComponent implements OnInit {
