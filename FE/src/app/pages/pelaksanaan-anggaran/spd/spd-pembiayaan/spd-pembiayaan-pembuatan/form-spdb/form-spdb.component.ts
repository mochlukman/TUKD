...
@Component({
  selector: 'app-form-spdb',
  templateUrl: './form-spdb.component.html',
  styleUrls: ['./form-spdb.component.scss']
})
export class FormSpdbComponent implements OnInit {
  ...
  simpan(){
    if(this.forms.valid){
      ...
      this.forms.patchValue({
        tglspd: this.forms.value.tglspd !== null ? new Date(this.forms.value.tglspd).toLocaleDateString() : null
      });
      if(this.mode === 'add'){
