...
import { FormSpdbComponent } from './form-spdb/form-spdb.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';


@Component({
  selector: 'app-spd-pembiayaan-pembuatan',
  templateUrl: './spd-pembiayaan-pembuatan.component.html',
  styleUrls: ['./spd-pembiayaan-pembuatan.component.scss']
})
export class SpdPembiayaanPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(FormSpdbComponent, {static: true}) Form: FormSpdbComponent;
