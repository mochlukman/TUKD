...
const routes: Routes = [
  {
    path:'sk-dpa-perubahan',
    component: SkDpaComponent,
    canActivate: [CanActiveGuardService],
    data: {setTitle: 'SK - DPA Perubahan'}
  },
  {
    path:'pendapatan',
    component: PendapatanComponent,
    canActivate: [CanActiveGuardService],
    data: {setTitle: 'DPA Perubahan - Pendapatan'}
  },
  {
    path:'belanja',
    component: BelanjaComponent,
    canActivate: [CanActiveGuardService],
    data: {setTitle: 'DPA Perubahan - Belanja'}
  },
  {
    path:'pembiayaan',
    component: PembiayaanComponent,
    canActivate: [CanActiveGuardService],
    data: {setTitle: 'DPA Perubahan - Pembiayaan'}
  },
];
