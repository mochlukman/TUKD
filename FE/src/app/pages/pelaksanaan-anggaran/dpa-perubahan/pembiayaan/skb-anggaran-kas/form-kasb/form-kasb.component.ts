...
@Component({
  selector: 'app-form-kasb',
  templateUrl: './form-kasb.component.html',
  styleUrls: ['./form-kasb.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormKasbComponent implements OnInit {
  ...
  @Output() callBack = new EventEmitter();
	constructor(
      ...
      iddpablnb: [0, Validators.required],
