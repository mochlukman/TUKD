...
@Component({
  selector: 'app-form-skb-penjabaran',
  templateUrl: './form-skb-penjabaran.component.html',
  styleUrls: ['./form-skb-penjabaran.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormSkbPenjabaranComponent implements OnInit {
