...
@Component({
  selector: 'app-spj-pengesahan-detail-belanja-rincian',
  templateUrl: './spj-pengesahan-detail-belanja-rincian.component.html',
  styleUrls: ['./spj-pengesahan-detail-belanja-rincian.component.scss']
})
export class SpjPengesahanDetailBelanjaRincianComponent implements OnInit {
  BpkSelected: IBpk;
  title: String;
  showThis: boolean;
  msg: Message[];
