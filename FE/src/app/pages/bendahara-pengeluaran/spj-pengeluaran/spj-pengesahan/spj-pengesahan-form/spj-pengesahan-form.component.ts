...
@Component({
  selector: 'app-spj-pengesahan-form',
  templateUrl: './spj-pengesahan-form.component.html',
  styleUrls: ['./spj-pengesahan-form.component.scss']
})
export class SpjPengesahanFormComponent implements OnInit {
  showThis: boolean;
