...
@Component({
  selector: 'app-tolak-ls-peg-form',
  templateUrl: './tolak-ls-peg-form.component.html',
  styleUrls: ['./tolak-ls-peg-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TolakLsPegFormComponent implements OnInit {
