...
@Component({
  selector: 'app-spp-ls-pegawai-pajaktolak',
  templateUrl: './spp-ls-pegawai-pajaktolak.component.html',
  styleUrls: ['./spp-ls-pegawai-pajaktolak.component.scss']
})
export class SppLsPegawaiPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
