...
import { TolakLsPegCheckComponent } from './tolak-ls-peg-check/tolak-ls-peg-check.component';
import { TolakLsPegFormComponent } from './tolak-ls-peg-form/tolak-ls-peg-form.component';

@Component({
  selector: 'app-tolak-ls-peg',
  templateUrl: './tolak-ls-peg.component.html',
  styleUrls: ['./tolak-ls-peg.component.scss']
})
export class TolakLsPegComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(TolakLsPegFormComponent, {static: true}) Form : TolakLsPegFormComponent;
  @ViewChild(TolakLsPegCheckComponent, {static: true}) Checks: TolakLsPegCheckComponent;
