...
@Component({
  selector: 'app-detail-ls-pegawai-pembebanantolak',
  templateUrl: './detail-ls-pegawai-pembebanantolak.component.html',
  styleUrls: ['./detail-ls-pegawai-pembebanantolak.component.scss']
})
export class DetailLsPegawaiPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
