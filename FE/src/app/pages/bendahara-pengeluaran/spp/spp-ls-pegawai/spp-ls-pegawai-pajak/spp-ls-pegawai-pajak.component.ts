...
import { SppLsPegawaiPajakFormComponent } from '../spp-ls-pegawai-pajak-form/spp-ls-pegawai-pajak-form.component';

@Component({
  selector: 'app-spp-ls-pegawai-pajak',
  templateUrl: './spp-ls-pegawai-pajak.component.html',
  styleUrls: ['./spp-ls-pegawai-pajak.component.scss']
})
export class SppLsPegawaiPajakComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(SppLsPegawaiPajakFormComponent,{static: true}) Form : SppLsPegawaiPajakFormComponent;
