...
import { FormSppDetailLsPegawaiComponent } from '../../form-spp-detail-ls-pegawai/form-spp-detail-ls-pegawai.component';

@Component({
  selector: 'app-detail-ls-pegawai-pembebanan',
  templateUrl: './detail-ls-pegawai-pembebanan.component.html',
  styleUrls: ['./detail-ls-pegawai-pembebanan.component.scss']
})
export class DetailLsPegawaiPembebananComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(FormSppDetailLsPegawaiComponent, {static: true}) Form : FormSppDetailLsPegawaiComponent;
