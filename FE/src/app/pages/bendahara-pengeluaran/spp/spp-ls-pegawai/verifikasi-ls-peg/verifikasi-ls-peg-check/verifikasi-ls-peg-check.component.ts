...
@Component({
  selector: 'app-verifikasi-ls-peg-check',
  templateUrl: './verifikasi-ls-peg-check.component.html',
  styleUrls: ['./verifikasi-ls-peg-check.component.scss']
})
export class VerifikasiLsPegCheckComponent implements OnInit {
