...
@Component({
  selector: 'app-spp-ls-pegawai-pajakver',
  templateUrl: './spp-ls-pegawai-pajakver.component.html',
  styleUrls: ['./spp-ls-pegawai-pajakver.component.scss']
})
export class SppLsPegawaiPajakverComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
