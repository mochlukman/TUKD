...
import { VerifikasiLsPegCheckComponent } from './verifikasi-ls-peg-check/verifikasi-ls-peg-check.component';
import { VerifikasiLsPegFormComponent } from './verifikasi-ls-peg-form/verifikasi-ls-peg-form.component';

@Component({
  selector: 'app-verifikasi-ls-peg',
  templateUrl: './verifikasi-ls-peg.component.html',
  styleUrls: ['./verifikasi-ls-peg.component.scss']
})
export class VerifikasiLsPegComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(VerifikasiLsPegFormComponent, {static: true}) Form : VerifikasiLsPegFormComponent;
  @ViewChild(VerifikasiLsPegCheckComponent, {static: true}) Checks: VerifikasiLsPegCheckComponent;
  ...
  lookKegiatan(){
    if(this.unitSelected){
      ...
      this.Kegiatan.get(this.formFilter.value.idunit, this.formFilter.value.kdtahap, false, 3); //parameter ke 4 = jnskeg, Non Pegawai SKPD
