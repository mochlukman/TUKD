...
@Component({
  selector: 'app-verifikasi-ls-peg-form',
  templateUrl: './verifikasi-ls-peg-form.component.html',
  styleUrls: ['./verifikasi-ls-peg-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class VerifikasiLsPegFormComponent implements OnInit {
