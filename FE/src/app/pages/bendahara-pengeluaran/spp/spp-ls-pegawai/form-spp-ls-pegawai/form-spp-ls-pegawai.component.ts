...
@Component({
  selector: 'app-form-spp-ls-pegawai',
  templateUrl: './form-spp-ls-pegawai.component.html',
  styleUrls: ['./form-spp-ls-pegawai.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormSppLsPegawaiComponent implements OnInit {
