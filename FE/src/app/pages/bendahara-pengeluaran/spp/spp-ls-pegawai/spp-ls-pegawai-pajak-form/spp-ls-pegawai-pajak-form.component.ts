...
@Component({
  selector: 'app-spp-ls-pegawai-pajak-form',
  templateUrl: './spp-ls-pegawai-pajak-form.component.html',
  styleUrls: ['./spp-ls-pegawai-pajak-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SppLsPegawaiPajakFormComponent implements OnInit {
