...
import { VerifikasiGuCheckComponent } from './verifikasi-gu-check/verifikasi-gu-check.component';
import { VerifikasiGuFormComponent } from './verifikasi-gu-form/verifikasi-gu-form.component';

@Component({
  selector: 'app-verifikasi-gu',
  templateUrl: './verifikasi-gu.component.html',
  styleUrls: ['./verifikasi-gu.component.scss']
})
export class VerifikasiGuComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(VerifikasiGuFormComponent, {static: true}) Form : VerifikasiGuFormComponent;
  @ViewChild(VerifikasiGuCheckComponent, {static: true}) Checks: VerifikasiGuCheckComponent;
