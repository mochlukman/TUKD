...
@Component({
  selector: 'app-verifikasi-gu-check',
  templateUrl: './verifikasi-gu-check.component.html',
  styleUrls: ['./verifikasi-gu-check.component.scss']
})
export class VerifikasiGuCheckComponent implements OnInit {
