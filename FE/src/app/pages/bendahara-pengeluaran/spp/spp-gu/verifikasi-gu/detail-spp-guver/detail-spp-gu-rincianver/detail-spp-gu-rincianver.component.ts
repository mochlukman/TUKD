...
@Component({
  selector: 'app-detail-spp-gu-rincianver',
  templateUrl: './detail-spp-gu-rincianver.component.html',
  styleUrls: ['./detail-spp-gu-rincianver.component.scss']
})
export class DetailSppGuRincianverComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
