...
import { FormSppGuComponent } from '../form-spp-gu/form-spp-gu.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-pembuatan-gu',
  templateUrl: './pembuatan-gu.component.html',
  styleUrls: ['./pembuatan-gu.component.scss']
})
export class PembuatanGuComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(FormSppGuComponent, {static: true}) Form : FormSppGuComponent;
