...
@Component({
  selector: 'app-detail-spp-gu-rincian-tolak',
  templateUrl: './detail-spp-gu-rincian-tolak.component.html',
  styleUrls: ['./detail-spp-gu-rincian-tolak.component.scss']
})
export class DetailSppGuRincianTolakComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
