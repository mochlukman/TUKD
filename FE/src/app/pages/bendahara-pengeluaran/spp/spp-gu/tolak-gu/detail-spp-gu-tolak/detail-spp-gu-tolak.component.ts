...
@Component({
  selector: 'app-detail-spp-gu-tolak',
  templateUrl: './detail-spp-gu-tolak.component.html',
  styleUrls: ['./detail-spp-gu-tolak.component.scss']
})
export class DetailSppGuTolakComponent implements OnInit, OnDestroy, OnChanges {
  tabIndex: number = 0;
