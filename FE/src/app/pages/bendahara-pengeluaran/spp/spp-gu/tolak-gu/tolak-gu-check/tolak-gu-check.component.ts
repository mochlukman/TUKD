...
@Component({
  selector: 'app-tolak-gu-check',
  templateUrl: './tolak-gu-check.component.html',
  styleUrls: ['./tolak-gu-check.component.scss']
})
export class TolakGuCheckComponent implements OnInit {
