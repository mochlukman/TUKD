...
@Component({
  selector: 'app-tolak-gu-from',
  templateUrl: './tolak-gu-from.component.html',
  styleUrls: ['./tolak-gu-from.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TolakGuFromComponent implements OnInit {
