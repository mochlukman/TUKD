...
@Component({
  selector: 'app-spp-ls-uangmuka-pajaktolak',
  templateUrl: './spp-ls-uangmuka-pajaktolak.component.html',
  styleUrls: ['./spp-ls-uangmuka-pajaktolak.component.scss']
})
export class SppLsUangmukaPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
