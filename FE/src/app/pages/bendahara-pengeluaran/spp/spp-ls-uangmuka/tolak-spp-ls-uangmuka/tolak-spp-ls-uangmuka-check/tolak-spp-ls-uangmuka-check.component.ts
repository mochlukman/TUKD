...
@Component({
  selector: 'app-tolak-spp-ls-uangmuka-check',
  templateUrl: './tolak-spp-ls-uangmuka-check.component.html',
  styleUrls: ['./tolak-spp-ls-uangmuka-check.component.scss']
})
export class TolakSppLsUangmukaCheckComponent implements OnInit {
