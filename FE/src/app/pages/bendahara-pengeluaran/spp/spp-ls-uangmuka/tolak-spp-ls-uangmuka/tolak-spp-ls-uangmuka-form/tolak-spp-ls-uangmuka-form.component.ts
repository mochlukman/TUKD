...
@Component({
  selector: 'app-tolak-spp-ls-uangmuka-form',
  templateUrl: './tolak-spp-ls-uangmuka-form.component.html',
  styleUrls: ['./tolak-spp-ls-uangmuka-form.component.scss']
})
export class TolakSppLsUangmukaFormComponent implements OnInit {
