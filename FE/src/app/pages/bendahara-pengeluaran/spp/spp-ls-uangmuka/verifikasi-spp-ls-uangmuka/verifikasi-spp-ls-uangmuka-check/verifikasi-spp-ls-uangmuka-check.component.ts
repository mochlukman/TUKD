...
@Component({
  selector: 'app-verifikasi-spp-ls-uangmuka-check',
  templateUrl: './verifikasi-spp-ls-uangmuka-check.component.html',
  styleUrls: ['./verifikasi-spp-ls-uangmuka-check.component.scss']
})
export class VerifikasiSppLsUangmukaCheckComponent implements OnInit {
