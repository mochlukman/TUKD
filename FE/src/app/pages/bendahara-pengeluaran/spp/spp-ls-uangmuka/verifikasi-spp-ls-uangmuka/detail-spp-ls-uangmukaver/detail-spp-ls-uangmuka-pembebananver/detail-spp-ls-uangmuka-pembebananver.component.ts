...
@Component({
  selector: 'app-detail-spp-ls-uangmuka-pembebananver',
  templateUrl: './detail-spp-ls-uangmuka-pembebananver.component.html',
  styleUrls: ['./detail-spp-ls-uangmuka-pembebananver.component.scss']
})
export class DetailSppLsUangmukaPembebananverComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ISppdetr[] = [];
