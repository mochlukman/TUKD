...
import { FormSppLsUangmukaComponent } from '../form-spp-ls-uangmuka/form-spp-ls-uangmuka.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-pembuatan-spp-ls-uangmuka',
  templateUrl: './pembuatan-spp-ls-uangmuka.component.html',
  styleUrls: ['./pembuatan-spp-ls-uangmuka.component.scss']
})
export class PembuatanSppLsUangmukaComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(FormSppLsUangmukaComponent, {static: true}) Form : FormSppLsUangmukaComponent;
