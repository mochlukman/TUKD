...
@Component({
  selector: 'app-form-spp-detail-ls-uangmuka',
  templateUrl: './form-spp-detail-ls-uangmuka.component.html',
  styleUrls: ['./form-spp-detail-ls-uangmuka.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormSppDetailLsUangmukaComponent implements OnInit {
