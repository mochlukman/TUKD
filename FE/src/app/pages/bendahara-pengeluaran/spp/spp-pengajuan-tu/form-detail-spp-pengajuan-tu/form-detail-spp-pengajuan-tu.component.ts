...
import { ISppdetrPostMultiKeg } from 'src/app/core/interface/isppdetr';
...
@Component({
  selector: 'app-form-detail-spp-pengajuan-tu',
  templateUrl: './form-detail-spp-pengajuan-tu.component.html',
  styleUrls: ['./form-detail-spp-pengajuan-tu.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormDetailSppPengajuanTuComponent implements OnInit {
