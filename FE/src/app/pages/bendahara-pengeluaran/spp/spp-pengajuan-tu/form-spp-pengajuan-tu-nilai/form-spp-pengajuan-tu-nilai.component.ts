...
@Component({
  selector: 'app-form-spp-pengajuan-tu-nilai',
  templateUrl: './form-spp-pengajuan-tu-nilai.component.html',
  styleUrls: ['./form-spp-pengajuan-tu-nilai.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class FormSppPengajuanTuNilaiComponent implements OnInit {
