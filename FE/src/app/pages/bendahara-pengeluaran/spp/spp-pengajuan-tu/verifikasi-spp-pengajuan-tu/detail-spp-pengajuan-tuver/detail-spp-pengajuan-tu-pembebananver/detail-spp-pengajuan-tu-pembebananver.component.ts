...
@Component({
  selector: 'app-detail-spp-pengajuan-tu-pembebananver',
  templateUrl: './detail-spp-pengajuan-tu-pembebananver.component.html',
  styleUrls: ['./detail-spp-pengajuan-tu-pembebananver.component.scss']
})
export class DetailSppPengajuanTuPembebananverComponent implements OnInit, OnChanges, OnDestroy {
