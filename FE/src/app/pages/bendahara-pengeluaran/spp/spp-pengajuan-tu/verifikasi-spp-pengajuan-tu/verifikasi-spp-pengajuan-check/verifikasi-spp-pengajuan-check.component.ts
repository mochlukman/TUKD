...
@Component({
  selector: 'app-verifikasi-spp-pengajuan-check',
  templateUrl: './verifikasi-spp-pengajuan-check.component.html',
  styleUrls: ['./verifikasi-spp-pengajuan-check.component.scss']
})
export class VerifikasiSppPengajuanCheckComponent implements OnInit {
