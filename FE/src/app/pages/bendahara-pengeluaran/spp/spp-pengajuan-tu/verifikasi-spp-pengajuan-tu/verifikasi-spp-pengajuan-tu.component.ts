...
import { VerifikasiSppPengajuanCheckComponent } from './verifikasi-spp-pengajuan-check/verifikasi-spp-pengajuan-check.component';
import { VerifikasiSppPengajuanFormComponent } from './verifikasi-spp-pengajuan-form/verifikasi-spp-pengajuan-form.component';

@Component({
  selector: 'app-verifikasi-spp-pengajuan-tu',
  templateUrl: './verifikasi-spp-pengajuan-tu.component.html',
  styleUrls: ['./verifikasi-spp-pengajuan-tu.component.scss']
})
export class VerifikasiSppPengajuanTuComponent implements OnInit {
  ...
  @ViewChild(VerifikasiSppPengajuanFormComponent, {static: true}) Form : VerifikasiSppPengajuanFormComponent;
  @ViewChild(VerifikasiSppPengajuanCheckComponent, {static: true}) Checks: VerifikasiSppPengajuanCheckComponent;
