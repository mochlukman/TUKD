...
import { TolakSppPengajuanTuCheckComponent } from './tolak-spp-pengajuan-tu-check/tolak-spp-pengajuan-tu-check.component';
import { TolakSppPengajuanTuFormComponent } from './tolak-spp-pengajuan-tu-form/tolak-spp-pengajuan-tu-form.component';

@Component({
  selector: 'app-tolak-spp-pengajuan-tu',
  templateUrl: './tolak-spp-pengajuan-tu.component.html',
  styleUrls: ['./tolak-spp-pengajuan-tu.component.scss']
})
export class TolakSppPengajuanTuComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(TolakSppPengajuanTuFormComponent, {static: true}) Form : TolakSppPengajuanTuFormComponent;
  @ViewChild(TolakSppPengajuanTuCheckComponent, {static: true}) Checks: TolakSppPengajuanTuCheckComponent;
