...
@Component({
  selector: 'app-tolak-spp-pengajuan-tu-check',
  templateUrl: './tolak-spp-pengajuan-tu-check.component.html',
  styleUrls: ['./tolak-spp-pengajuan-tu-check.component.scss']
})
export class TolakSppPengajuanTuCheckComponent implements OnInit {
