...
@Component({
  selector: 'app-verifikasi-spp-tu-check',
  templateUrl: './verifikasi-spp-tu-check.component.html',
  styleUrls: ['./verifikasi-spp-tu-check.component.scss']
})
export class VerifikasiSppTuCheckComponent implements OnInit {
