...
import { VerifikasiSppTuCheckComponent } from './verifikasi-spp-tu-check/verifikasi-spp-tu-check.component';
import { VerifikasiSppTuFormComponent } from './verifikasi-spp-tu-form/verifikasi-spp-tu-form.component';

@Component({
  selector: 'app-verifikasi-spp-tu',
  templateUrl: './verifikasi-spp-tu.component.html',
  styleUrls: ['./verifikasi-spp-tu.component.scss']
})
export class VerifikasiSppTuComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(VerifikasiSppTuFormComponent, {static: true}) Form : VerifikasiSppTuFormComponent;
  @ViewChild(VerifikasiSppTuCheckComponent, {static: true}) Checks: VerifikasiSppTuCheckComponent;
  ...
  get(){
    if(this.unitSelected && this.tabIndex == 1){
