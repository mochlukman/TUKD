...
@Component({
  selector: 'app-verifikasi-spp-tu-form',
  templateUrl: './verifikasi-spp-tu-form.component.html',
  styleUrls: ['./verifikasi-spp-tu-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class VerifikasiSppTuFormComponent implements OnInit {
