...
@Component({
  selector: 'app-detail-spp-tu-pembebananver',
  templateUrl: './detail-spp-tu-pembebananver.component.html',
  styleUrls: ['./detail-spp-tu-pembebananver.component.scss']
})
export class DetailSppTuPembebananverComponent implements OnInit, OnChanges, OnDestroy {
