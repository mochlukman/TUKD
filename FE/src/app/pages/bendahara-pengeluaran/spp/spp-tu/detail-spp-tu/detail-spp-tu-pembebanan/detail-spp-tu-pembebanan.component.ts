...
import { ISppdetr, ISppdetrData, ISppdetrTreeRoot } from 'src/app/core/interface/isppdetr';
import { ITokenClaim } from 'src/app/core/interface/itoken-claim';
import { AuthenticationService } from 'src/app/core/services/auth.service';
import { SppdetrService } from 'src/app/core/services/sppdetr.service';
import { NotifService } from 'src/app/core/_commonServices/notif.service';
import { FormDetailSppTuComponent } from '../../form-detail-spp-tu/form-detail-spp-tu.component';
import { FormSppTuNilaiComponent } from '../../form-spp-tu-nilai/form-spp-tu-nilai.component';

@Component({
  selector: 'app-detail-spp-tu-pembebanan',
  templateUrl: './detail-spp-tu-pembebanan.component.html',
  styleUrls: ['./detail-spp-tu-pembebanan.component.scss']
})
export class DetailSppTuPembebananComponent implements OnInit, OnDestroy, OnChanges {
  @Input() tabIndex: number = 0;
  loading: boolean;
  listdata: ISppdetrTreeRoot[] = [];
  @Input() SppSelected : ISpp;
  userInfo: ITokenClaim;
  @ViewChild(FormDetailSppTuComponent, {static: true}) Form : FormDetailSppTuComponent;
  @ViewChild(FormSppTuNilaiComponent, {static: true}) FormNilai: FormSppTuNilaiComponent;
