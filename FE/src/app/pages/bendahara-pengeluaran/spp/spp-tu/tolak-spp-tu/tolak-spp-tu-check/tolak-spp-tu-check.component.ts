...
@Component({
  selector: 'app-tolak-spp-tu-check',
  templateUrl: './tolak-spp-tu-check.component.html',
  styleUrls: ['./tolak-spp-tu-check.component.scss']
})
export class TolakSppTuCheckComponent implements OnInit {
