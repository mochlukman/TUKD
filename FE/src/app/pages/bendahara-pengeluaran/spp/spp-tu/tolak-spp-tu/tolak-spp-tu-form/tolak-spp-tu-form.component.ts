...
@Component({
  selector: 'app-tolak-spp-tu-form',
  templateUrl: './tolak-spp-tu-form.component.html',
  styleUrls: ['./tolak-spp-tu-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TolakSppTuFormComponent implements OnInit {
