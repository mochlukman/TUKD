...
@Component({
  selector: 'app-detal-spp-tu-pembebanantolak',
  templateUrl: './detal-spp-tu-pembebanantolak.component.html',
  styleUrls: ['./detal-spp-tu-pembebanantolak.component.scss']
})
export class DetalSppTuPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
