...
import { TolakSppTuCheckComponent } from './tolak-spp-tu-check/tolak-spp-tu-check.component';
import { TolakSppTuFormComponent } from './tolak-spp-tu-form/tolak-spp-tu-form.component';

@Component({
  selector: 'app-tolak-spp-tu',
  templateUrl: './tolak-spp-tu.component.html',
  styleUrls: ['./tolak-spp-tu.component.scss']
})
export class TolakSppTuComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(TolakSppTuFormComponent, {static: true}) Form : TolakSppTuFormComponent;
  @ViewChild(TolakSppTuCheckComponent, {static: true}) Checks: TolakSppTuCheckComponent;
  ...
  get(){
    if(this.unitSelected && this.tabIndex == 2){
