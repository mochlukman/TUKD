...
@Component({
  selector: 'app-pengesahan-up-check',
  templateUrl: './pengesahan-up-check.component.html',
  styleUrls: ['./pengesahan-up-check.component.scss']
})
export class PengesahanUpCheckComponent implements OnInit {
