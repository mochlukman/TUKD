...
@Component({
  selector: 'app-pengesahan-up-form',
  templateUrl: './pengesahan-up-form.component.html',
  styleUrls: ['./pengesahan-up-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PengesahanUpFormComponent implements OnInit {
