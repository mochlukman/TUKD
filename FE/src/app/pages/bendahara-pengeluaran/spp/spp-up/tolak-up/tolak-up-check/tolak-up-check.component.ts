...
@Component({
  selector: 'app-tolak-up-check',
  templateUrl: './tolak-up-check.component.html',
  styleUrls: ['./tolak-up-check.component.scss']
})
export class TolakUpCheckComponent implements OnInit {
