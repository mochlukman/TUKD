...
@Component({
  selector: 'app-tolak-up-form',
  templateUrl: './tolak-up-form.component.html',
  styleUrls: ['./tolak-up-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TolakUpFormComponent implements OnInit {
