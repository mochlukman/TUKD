...
import { FormSppUpComponent } from '../form-spp-up/form-spp-up.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-pembuatan-up',
  templateUrl: './pembuatan-up.component.html',
  styleUrls: ['./pembuatan-up.component.scss']
})
export class PembuatanUpComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(FormSppUpComponent, {static: true}) Form : FormSppUpComponent;
