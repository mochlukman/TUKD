...
@Component({
  selector: 'app-verifikasi-ls-nonpeg-check',
  templateUrl: './verifikasi-ls-nonpeg-check.component.html',
  styleUrls: ['./verifikasi-ls-nonpeg-check.component.scss']
})
export class VerifikasiLsNonpegCheckComponent implements OnInit {
