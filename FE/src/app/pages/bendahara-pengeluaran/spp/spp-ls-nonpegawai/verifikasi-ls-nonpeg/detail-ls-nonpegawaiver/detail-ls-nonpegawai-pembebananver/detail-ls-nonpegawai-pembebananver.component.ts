...
@Component({
  selector: 'app-detail-ls-nonpegawai-pembebananver',
  templateUrl: './detail-ls-nonpegawai-pembebananver.component.html',
  styleUrls: ['./detail-ls-nonpegawai-pembebananver.component.scss']
})
export class DetailLsNonpegawaiPembebananverComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ISppdetr[] = [];
