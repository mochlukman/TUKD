...
@Component({
  selector: 'app-detail-ls-nonpegawaiver',
  templateUrl: './detail-ls-nonpegawaiver.component.html',
  styleUrls: ['./detail-ls-nonpegawaiver.component.scss']
})
export class DetailLsNonpegawaiverComponent implements OnInit, OnChanges, OnDestroy {
  tabIndex: number = 0;
