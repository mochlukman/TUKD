...
@Component({
  selector: 'app-verifikasi-ls-nonpeg-form',
  templateUrl: './verifikasi-ls-nonpeg-form.component.html',
  styleUrls: ['./verifikasi-ls-nonpeg-form.component.scss']
})
export class VerifikasiLsNonpegFormComponent implements OnInit {
