...
@Component({
  selector: 'app-spp-ls-nonpegawai-pajakver',
  templateUrl: './spp-ls-nonpegawai-pajakver.component.html',
  styleUrls: ['./spp-ls-nonpegawai-pajakver.component.scss']
})
export class SppLsNonpegawaiPajakverComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
