...
@Component({
  selector: 'app-form-spp-ls-nonpegawai',
  templateUrl: './form-spp-ls-nonpegawai.component.html',
  styleUrls: ['./form-spp-ls-nonpegawai.component.scss']
})
export class FormSppLsNonpegawaiComponent implements OnInit {
