...
import { SppLsNonpegawaiPajakFormComponent } from '../spp-ls-nonpegawai-pajak-form/spp-ls-nonpegawai-pajak-form.component';

@Component({
  selector: 'app-spp-ls-nonpegawai-pajak',
  templateUrl: './spp-ls-nonpegawai-pajak.component.html',
  styleUrls: ['./spp-ls-nonpegawai-pajak.component.scss']
})
export class SppLsNonpegawaiPajakComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(SppLsNonpegawaiPajakFormComponent,{static: true}) Form : SppLsNonpegawaiPajakFormComponent;
