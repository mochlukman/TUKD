...
@Component({
  selector: 'app-detail-ls-nonpegawaitolak',
  templateUrl: './detail-ls-nonpegawaitolak.component.html',
  styleUrls: ['./detail-ls-nonpegawaitolak.component.scss']
})
export class DetailLsNonpegawaitolakComponent implements OnInit, OnChanges, OnDestroy {
  tabIndex: number = 0;
