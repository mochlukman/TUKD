...
@Component({
  selector: 'app-spp-ls-nonpegawai-pajaktolak',
  templateUrl: './spp-ls-nonpegawai-pajaktolak.component.html',
  styleUrls: ['./spp-ls-nonpegawai-pajaktolak.component.scss']
})
export class SppLsNonpegawaiPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
