...
@Component({
  selector: 'app-tolak-ls-nonpeg-check',
  templateUrl: './tolak-ls-nonpeg-check.component.html',
  styleUrls: ['./tolak-ls-nonpeg-check.component.scss']
})
export class TolakLsNonpegCheckComponent implements OnInit {
