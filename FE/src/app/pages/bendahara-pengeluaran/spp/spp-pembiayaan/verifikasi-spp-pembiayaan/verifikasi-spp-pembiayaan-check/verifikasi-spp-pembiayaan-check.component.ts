...
@Component({
  selector: 'app-verifikasi-spp-pembiayaan-check',
  templateUrl: './verifikasi-spp-pembiayaan-check.component.html',
  styleUrls: ['./verifikasi-spp-pembiayaan-check.component.scss']
})
export class VerifikasiSppPembiayaanCheckComponent implements OnInit {
