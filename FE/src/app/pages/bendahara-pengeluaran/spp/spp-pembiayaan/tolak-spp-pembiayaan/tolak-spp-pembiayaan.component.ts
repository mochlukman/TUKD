...
import { TolakSppPembiayaanCheckComponent } from './tolak-spp-pembiayaan-check/tolak-spp-pembiayaan-check.component';
import { TolakSppPembiayaanFormComponent } from './tolak-spp-pembiayaan-form/tolak-spp-pembiayaan-form.component';

@Component({
  selector: 'app-tolak-spp-pembiayaan',
  templateUrl: './tolak-spp-pembiayaan.component.html',
  styleUrls: ['./tolak-spp-pembiayaan.component.scss']
})
export class TolakSppPembiayaanComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(TolakSppPembiayaanFormComponent, {static: true}) Form : TolakSppPembiayaanFormComponent;
  @ViewChild(TolakSppPembiayaanCheckComponent, {static: true}) Checks: TolakSppPembiayaanCheckComponent;
