...
@Component({
  selector: 'app-tolak-spp-pembiayaan-form',
  templateUrl: './tolak-spp-pembiayaan-form.component.html',
  styleUrls: ['./tolak-spp-pembiayaan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TolakSppPembiayaanFormComponent implements OnInit {
