...
@Component({
  selector: 'app-tolak-spp-pembiayaan-check',
  templateUrl: './tolak-spp-pembiayaan-check.component.html',
  styleUrls: ['./tolak-spp-pembiayaan-check.component.scss']
})
export class TolakSppPembiayaanCheckComponent implements OnInit {
