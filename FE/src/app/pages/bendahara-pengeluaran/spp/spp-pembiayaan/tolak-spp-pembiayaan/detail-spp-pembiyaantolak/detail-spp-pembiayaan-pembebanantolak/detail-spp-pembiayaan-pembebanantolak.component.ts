...
@Component({
  selector: 'app-detail-spp-pembiayaan-pembebanantolak',
  templateUrl: './detail-spp-pembiayaan-pembebanantolak.component.html',
  styleUrls: ['./detail-spp-pembiayaan-pembebanantolak.component.scss']
})
export class DetailSppPembiayaanPembebanantolakComponent implements OnInit, OnDestroy, OnChanges {
