...
@Component({
  selector: 'app-spm-pembiayaan-detail-pembebanantolak',
  templateUrl: './spm-pembiayaan-detail-pembebanantolak.component.html',
  styleUrls: ['./spm-pembiayaan-detail-pembebanantolak.component.scss']
})
export class SpmPembiayaanDetailPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
