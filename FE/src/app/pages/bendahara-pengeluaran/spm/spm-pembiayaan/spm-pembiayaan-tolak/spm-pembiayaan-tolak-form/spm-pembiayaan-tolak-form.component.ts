...
@Component({
  selector: 'app-spm-pembiayaan-tolak-form',
  templateUrl: './spm-pembiayaan-tolak-form.component.html',
  styleUrls: ['./spm-pembiayaan-tolak-form.component.scss']
})
export class SpmPembiayaanTolakFormComponent implements OnInit {
