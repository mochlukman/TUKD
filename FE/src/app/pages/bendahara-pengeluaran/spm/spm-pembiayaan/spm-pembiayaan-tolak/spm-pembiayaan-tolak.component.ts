...
import { SpmPembiayaanTolakFormComponent } from './spm-pembiayaan-tolak-form/spm-pembiayaan-tolak-form.component';

@Component({
  selector: 'app-spm-pembiayaan-tolak',
  templateUrl: './spm-pembiayaan-tolak.component.html',
  styleUrls: ['./spm-pembiayaan-tolak.component.scss']
})
export class SpmPembiayaanTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmPembiayaanTolakFormComponent, {static: true}) Form : SpmPembiayaanTolakFormComponent;
