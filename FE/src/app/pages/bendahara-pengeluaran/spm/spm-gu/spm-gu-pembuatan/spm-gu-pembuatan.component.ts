...
import { SpmGuFormPembuatanComponent } from './spm-gu-form-pembuatan/spm-gu-form-pembuatan.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-spm-gu-pembuatan',
  templateUrl: './spm-gu-pembuatan.component.html',
  styleUrls: ['./spm-gu-pembuatan.component.scss']
})
export class SpmGuPembuatanComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmGuFormPembuatanComponent, {static: true}) Form : SpmGuFormPembuatanComponent;
