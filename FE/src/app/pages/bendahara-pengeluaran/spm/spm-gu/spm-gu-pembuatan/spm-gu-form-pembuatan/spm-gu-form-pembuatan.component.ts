...
@Component({
  selector: 'app-spm-gu-form-pembuatan',
  templateUrl: './spm-gu-form-pembuatan.component.html',
  styleUrls: ['./spm-gu-form-pembuatan.component.scss']
})
export class SpmGuFormPembuatanComponent implements OnInit {
  ...
  callbackSpp(e: ISpp){
    ...
    this.forms.patchValue({
      ...
      tglspd: this.sppSelected.idspdNavigation.tglspd != null ? new Date(this.sppSelected.idspdNavigation.tglspd).toLocaleDateString() : null,
