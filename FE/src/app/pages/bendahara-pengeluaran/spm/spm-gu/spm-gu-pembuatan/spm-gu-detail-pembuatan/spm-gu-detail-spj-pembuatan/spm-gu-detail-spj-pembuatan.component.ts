...
@Component({
  selector: 'app-spm-gu-detail-spj-pembuatan',
  templateUrl: './spm-gu-detail-spj-pembuatan.component.html',
  styleUrls: ['./spm-gu-detail-spj-pembuatan.component.scss']
})
export class SpmGuDetailSpjPembuatanComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ISpjspp[] = [];
