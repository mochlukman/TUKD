...
@Component({
  selector: 'app-spm-gu-detail-rincian-tolak',
  templateUrl: './spm-gu-detail-rincian-tolak.component.html',
  styleUrls: ['./spm-gu-detail-rincian-tolak.component.scss']
})
export class SpmGuDetailRincianTolakComponent implements OnInit, OnChanges, OnDestroy {
