...
import { SpmGuFormTolakComponent } from './spm-gu-form-tolak/spm-gu-form-tolak.component';

@Component({
  selector: 'app-spm-gu-tolak',
  templateUrl: './spm-gu-tolak.component.html',
  styleUrls: ['./spm-gu-tolak.component.scss']
})
export class SpmGuTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmGuFormTolakComponent, {static: true}) Form : SpmGuFormTolakComponent;
