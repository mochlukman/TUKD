...
@Component({
  selector: 'app-spm-gu-detail-spj-tolak',
  templateUrl: './spm-gu-detail-spj-tolak.component.html',
  styleUrls: ['./spm-gu-detail-spj-tolak.component.scss']
})
export class SpmGuDetailSpjTolakComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ISpjspp[] = [];
