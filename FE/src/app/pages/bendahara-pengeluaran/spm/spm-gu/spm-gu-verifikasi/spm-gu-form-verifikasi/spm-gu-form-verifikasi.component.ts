...
@Component({
  selector: 'app-spm-gu-form-verifikasi',
  templateUrl: './spm-gu-form-verifikasi.component.html',
  styleUrls: ['./spm-gu-form-verifikasi.component.scss']
})
export class SpmGuFormVerifikasiComponent implements OnInit {
