...
@Component({
  selector: 'app-spm-up-tolak-form',
  templateUrl: './spm-up-tolak-form.component.html',
  styleUrls: ['./spm-up-tolak-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SpmUpTolakFormComponent implements OnInit {
