...
@Component({
  selector: 'app-spm-up-verifikasi-form',
  templateUrl: './spm-up-verifikasi-form.component.html',
  styleUrls: ['./spm-up-verifikasi-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SpmUpVerifikasiFormComponent implements OnInit {
