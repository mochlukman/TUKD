...
import { SpmTuVerifikasiFormComponent } from './spm-tu-verifikasi-form/spm-tu-verifikasi-form.component';

@Component({
  selector: 'app-spm-tu-verifikasi',
  templateUrl: './spm-tu-verifikasi.component.html',
  styleUrls: ['./spm-tu-verifikasi.component.scss']
})
export class SpmTuVerifikasiComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmTuVerifikasiFormComponent, {static: true}) Form : SpmTuVerifikasiFormComponent;
