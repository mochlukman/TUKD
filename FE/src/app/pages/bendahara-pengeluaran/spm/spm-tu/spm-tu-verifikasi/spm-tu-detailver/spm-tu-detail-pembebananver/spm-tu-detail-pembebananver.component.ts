...
@Component({
  selector: 'app-spm-tu-detail-pembebananver',
  templateUrl: './spm-tu-detail-pembebananver.component.html',
  styleUrls: ['./spm-tu-detail-pembebananver.component.scss']
})
export class SpmTuDetailPembebananverComponent implements OnInit, OnChanges, OnDestroy {
