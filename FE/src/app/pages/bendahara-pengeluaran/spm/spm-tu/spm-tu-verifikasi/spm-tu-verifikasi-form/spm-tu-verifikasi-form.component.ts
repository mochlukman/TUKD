...
@Component({
  selector: 'app-spm-tu-verifikasi-form',
  templateUrl: './spm-tu-verifikasi-form.component.html',
  styleUrls: ['./spm-tu-verifikasi-form.component.scss']
})
export class SpmTuVerifikasiFormComponent implements OnInit {
