...
@Component({
  selector: 'app-spm-tu-detail-pembebanan',
  templateUrl: './spm-tu-detail-pembebanan.component.html',
  styleUrls: ['./spm-tu-detail-pembebanan.component.scss']
})
export class SpmTuDetailPembebananComponent implements OnInit, OnDestroy, OnChanges {
