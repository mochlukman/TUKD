...
import { SpmTuFormComponent } from '../spm-tu-form/spm-tu-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-spm-tu-pembuatan',
  templateUrl: './spm-tu-pembuatan.component.html',
  styleUrls: ['./spm-tu-pembuatan.component.scss']
})
export class SpmTuPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(SpmTuFormComponent, {static: true}) Form : SpmTuFormComponent;
