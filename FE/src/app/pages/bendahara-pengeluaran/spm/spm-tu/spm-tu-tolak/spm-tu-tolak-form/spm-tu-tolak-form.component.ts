...
@Component({
  selector: 'app-spm-tu-tolak-form',
  templateUrl: './spm-tu-tolak-form.component.html',
  styleUrls: ['./spm-tu-tolak-form.component.scss']
})
export class SpmTuTolakFormComponent implements OnInit {
