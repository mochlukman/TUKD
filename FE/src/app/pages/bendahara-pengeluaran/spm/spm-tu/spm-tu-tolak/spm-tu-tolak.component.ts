...
import { SpmTuTolakFormComponent } from './spm-tu-tolak-form/spm-tu-tolak-form.component';

@Component({
  selector: 'app-spm-tu-tolak',
  templateUrl: './spm-tu-tolak.component.html',
  styleUrls: ['./spm-tu-tolak.component.scss']
})
export class SpmTuTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmTuTolakFormComponent, {static: true}) Form : SpmTuTolakFormComponent;
