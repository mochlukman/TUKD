...
@Component({
  selector: 'app-spm-tu-detail-pembebanantolak',
  templateUrl: './spm-tu-detail-pembebanantolak.component.html',
  styleUrls: ['./spm-tu-detail-pembebanantolak.component.scss']
})
export class SpmTuDetailPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
