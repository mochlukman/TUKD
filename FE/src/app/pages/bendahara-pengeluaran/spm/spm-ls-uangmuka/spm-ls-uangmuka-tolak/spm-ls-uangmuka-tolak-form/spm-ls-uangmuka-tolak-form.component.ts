...
@Component({
  selector: 'app-spm-ls-uangmuka-tolak-form',
  templateUrl: './spm-ls-uangmuka-tolak-form.component.html',
  styleUrls: ['./spm-ls-uangmuka-tolak-form.component.scss']
})
export class SpmLsUangmukaTolakFormComponent implements OnInit {
