...
@Component({
  selector: 'app-spm-ls-uangmuka-detail-pembebanantolak',
  templateUrl: './spm-ls-uangmuka-detail-pembebanantolak.component.html',
  styleUrls: ['./spm-ls-uangmuka-detail-pembebanantolak.component.scss']
})
export class SpmLsUangmukaDetailPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
