...
import { SpmLsUangmukaTolakFormComponent } from './spm-ls-uangmuka-tolak-form/spm-ls-uangmuka-tolak-form.component';

@Component({
  selector: 'app-spm-ls-uangmuka-tolak',
  templateUrl: './spm-ls-uangmuka-tolak.component.html',
  styleUrls: ['./spm-ls-uangmuka-tolak.component.scss']
})
export class SpmLsUangmukaTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmLsUangmukaTolakFormComponent, {static: true}) Form : SpmLsUangmukaTolakFormComponent;
