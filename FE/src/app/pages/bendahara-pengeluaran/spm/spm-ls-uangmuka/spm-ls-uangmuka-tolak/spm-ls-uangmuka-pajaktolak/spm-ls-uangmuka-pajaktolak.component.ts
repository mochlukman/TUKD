...
@Component({
  selector: 'app-spm-ls-uangmuka-pajaktolak',
  templateUrl: './spm-ls-uangmuka-pajaktolak.component.html',
  styleUrls: ['./spm-ls-uangmuka-pajaktolak.component.scss']
})
export class SpmLsUangmukaPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
