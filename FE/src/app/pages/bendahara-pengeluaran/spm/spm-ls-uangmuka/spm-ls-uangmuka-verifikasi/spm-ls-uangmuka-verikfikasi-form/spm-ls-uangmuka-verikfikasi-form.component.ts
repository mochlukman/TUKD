...
@Component({
  selector: 'app-spm-ls-uangmuka-verikfikasi-form',
  templateUrl: './spm-ls-uangmuka-verikfikasi-form.component.html',
  styleUrls: ['./spm-ls-uangmuka-verikfikasi-form.component.scss']
})
export class SpmLsUangmukaVerikfikasiFormComponent implements OnInit {
