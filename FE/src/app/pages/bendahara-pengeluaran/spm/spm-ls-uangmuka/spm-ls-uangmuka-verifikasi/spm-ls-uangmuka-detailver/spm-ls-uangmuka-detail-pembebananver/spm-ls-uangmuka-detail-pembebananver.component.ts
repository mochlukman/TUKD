...
@Component({
  selector: 'app-spm-ls-uangmuka-detail-pembebananver',
  templateUrl: './spm-ls-uangmuka-detail-pembebananver.component.html',
  styleUrls: ['./spm-ls-uangmuka-detail-pembebananver.component.scss']
})
export class SpmLsUangmukaDetailPembebananverComponent implements OnInit, OnDestroy, OnChanges {
