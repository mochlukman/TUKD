...
@Component({
  selector: 'app-spm-ls-uangmuka-pajakver',
  templateUrl: './spm-ls-uangmuka-pajakver.component.html',
  styleUrls: ['./spm-ls-uangmuka-pajakver.component.scss']
})
export class SpmLsUangmukaPajakverComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
