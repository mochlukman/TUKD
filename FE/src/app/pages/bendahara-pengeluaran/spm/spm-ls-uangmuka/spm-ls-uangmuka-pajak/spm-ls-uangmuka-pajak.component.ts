...
@Component({
  selector: 'app-spm-ls-uangmuka-pajak',
  templateUrl: './spm-ls-uangmuka-pajak.component.html',
  styleUrls: ['./spm-ls-uangmuka-pajak.component.scss']
})
export class SpmLsUangmukaPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
