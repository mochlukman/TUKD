...
import { SpmLsUangmukaFormComponent } from '../spm-ls-uangmuka-form/spm-ls-uangmuka-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';


@Component({
  selector: 'app-spm-ls-uangmuka-pembuatan',
  templateUrl: './spm-ls-uangmuka-pembuatan.component.html',
  styleUrls: ['./spm-ls-uangmuka-pembuatan.component.scss']
})
export class SpmLsUangmukaPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(SpmLsUangmukaFormComponent, {static: true}) Form : SpmLsUangmukaFormComponent;
        ...
        .subscribe(resp => {
          if(resp.noreg){
            ...
            .subscribe(resp => {
              ...
              this.Form.title = 'Tambah SPM - LS Uang Muka';
              this.Form.mode = 'add';
  ...
  update(e: ISpm){
    ...
    this.Form.title = 'Ubah SPM - LS Uang Muka';
    this.Form.mode = 'edit';
