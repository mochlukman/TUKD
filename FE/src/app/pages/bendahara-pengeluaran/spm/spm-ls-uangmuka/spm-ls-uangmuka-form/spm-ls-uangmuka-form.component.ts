...
@Component({
  selector: 'app-spm-ls-uangmuka-form',
  templateUrl: './spm-ls-uangmuka-form.component.html',
  styleUrls: ['./spm-ls-uangmuka-form.component.scss']
})
export class SpmLsUangmukaFormComponent implements OnInit {
