...
@Component({
  selector: 'app-spm-ls-pegawai-pajakver',
  templateUrl: './spm-ls-pegawai-pajakver.component.html',
  styleUrls: ['./spm-ls-pegawai-pajakver.component.scss']
})
export class SpmLsPegawaiPajakverComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
