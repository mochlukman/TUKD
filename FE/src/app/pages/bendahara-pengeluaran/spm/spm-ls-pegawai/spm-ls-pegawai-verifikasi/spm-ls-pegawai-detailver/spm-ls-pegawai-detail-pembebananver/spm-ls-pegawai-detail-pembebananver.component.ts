...
@Component({
  selector: 'app-spm-ls-pegawai-detail-pembebananver',
  templateUrl: './spm-ls-pegawai-detail-pembebananver.component.html',
  styleUrls: ['./spm-ls-pegawai-detail-pembebananver.component.scss']
})
export class SpmLsPegawaiDetailPembebananverComponent implements OnInit, OnChanges, OnDestroy {
