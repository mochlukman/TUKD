...
@Component({
  selector: 'app-spm-ls-pegawai-detail-pembebanan',
  templateUrl: './spm-ls-pegawai-detail-pembebanan.component.html',
  styleUrls: ['./spm-ls-pegawai-detail-pembebanan.component.scss']
})
export class SpmLsPegawaiDetailPembebananComponent implements OnInit, OnDestroy, OnChanges {
