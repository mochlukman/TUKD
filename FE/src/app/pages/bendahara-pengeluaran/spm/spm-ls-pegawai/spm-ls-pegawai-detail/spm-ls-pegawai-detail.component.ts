...
@Component({
  selector: 'app-spm-ls-pegawai-detail',
  templateUrl: './spm-ls-pegawai-detail.component.html',
  styleUrls: ['./spm-ls-pegawai-detail.component.scss']
})
export class SpmLsPegawaiDetailComponent implements OnInit, OnDestroy, OnChanges {
  tabIndex: number = 0;
