...
@Component({
  selector: 'app-spm-ls-pegawai-form',
  templateUrl: './spm-ls-pegawai-form.component.html',
  styleUrls: ['./spm-ls-pegawai-form.component.scss']
})
export class SpmLsPegawaiFormComponent implements OnInit {
