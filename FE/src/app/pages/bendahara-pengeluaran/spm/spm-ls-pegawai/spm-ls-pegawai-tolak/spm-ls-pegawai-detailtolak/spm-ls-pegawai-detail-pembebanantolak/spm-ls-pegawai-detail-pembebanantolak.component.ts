...
@Component({
  selector: 'app-spm-ls-pegawai-detail-pembebanantolak',
  templateUrl: './spm-ls-pegawai-detail-pembebanantolak.component.html',
  styleUrls: ['./spm-ls-pegawai-detail-pembebanantolak.component.scss']
})
export class SpmLsPegawaiDetailPembebanantolakComponent implements OnInit, OnChanges, OnDestroy {
