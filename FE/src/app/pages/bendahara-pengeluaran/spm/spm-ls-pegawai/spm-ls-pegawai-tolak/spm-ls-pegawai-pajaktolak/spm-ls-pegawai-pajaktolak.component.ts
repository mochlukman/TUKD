...
@Component({
  selector: 'app-spm-ls-pegawai-pajaktolak',
  templateUrl: './spm-ls-pegawai-pajaktolak.component.html',
  styleUrls: ['./spm-ls-pegawai-pajaktolak.component.scss']
})
export class SpmLsPegawaiPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
