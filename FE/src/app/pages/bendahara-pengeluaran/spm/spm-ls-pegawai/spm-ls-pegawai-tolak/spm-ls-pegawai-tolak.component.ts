...
import { SpmLsPegawaiTolakFormComponent } from './spm-ls-pegawai-tolak-form/spm-ls-pegawai-tolak-form.component';

@Component({
  selector: 'app-spm-ls-pegawai-tolak',
  templateUrl: './spm-ls-pegawai-tolak.component.html',
  styleUrls: ['./spm-ls-pegawai-tolak.component.scss']
})
export class SpmLsPegawaiTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmLsPegawaiTolakFormComponent, {static: true}) Form : SpmLsPegawaiTolakFormComponent;
