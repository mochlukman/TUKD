...
@Component({
  selector: 'app-spm-ls-pegawai-tolak-form',
  templateUrl: './spm-ls-pegawai-tolak-form.component.html',
  styleUrls: ['./spm-ls-pegawai-tolak-form.component.scss']
})
export class SpmLsPegawaiTolakFormComponent implements OnInit {
