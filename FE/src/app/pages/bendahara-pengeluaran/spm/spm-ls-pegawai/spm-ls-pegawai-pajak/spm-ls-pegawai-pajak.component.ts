...
@Component({
  selector: 'app-spm-ls-pegawai-pajak',
  templateUrl: './spm-ls-pegawai-pajak.component.html',
  styleUrls: ['./spm-ls-pegawai-pajak.component.scss']
})
export class SpmLsPegawaiPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
