...
@Component({
  selector: 'app-spm-ls-nonpegawai-pajakver',
  templateUrl: './spm-ls-nonpegawai-pajakver.component.html',
  styleUrls: ['./spm-ls-nonpegawai-pajakver.component.scss']
})
export class SpmLsNonpegawaiPajakverComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
