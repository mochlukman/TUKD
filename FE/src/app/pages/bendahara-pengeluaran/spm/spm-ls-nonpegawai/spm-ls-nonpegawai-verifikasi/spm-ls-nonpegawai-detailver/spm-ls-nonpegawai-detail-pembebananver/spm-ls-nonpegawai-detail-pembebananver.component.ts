...
@Component({
  selector: 'app-spm-ls-nonpegawai-detail-pembebananver',
  templateUrl: './spm-ls-nonpegawai-detail-pembebananver.component.html',
  styleUrls: ['./spm-ls-nonpegawai-detail-pembebananver.component.scss']
})
export class SpmLsNonpegawaiDetailPembebananverComponent implements OnInit, OnChanges, OnDestroy {
