...
import { SpmLsNonpegawaiTolakFormComponent } from './spm-ls-nonpegawai-tolak-form/spm-ls-nonpegawai-tolak-form.component';

@Component({
  selector: 'app-spm-ls-nonpegawai-tolak',
  templateUrl: './spm-ls-nonpegawai-tolak.component.html',
  styleUrls: ['./spm-ls-nonpegawai-tolak.component.scss']
})
export class SpmLsNonpegawaiTolakComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(SpmLsNonpegawaiTolakFormComponent, {static: true}) Form : SpmLsNonpegawaiTolakFormComponent;
