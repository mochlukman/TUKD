...
@Component({
  selector: 'app-spm-ls-nonpegawai-tolak-form',
  templateUrl: './spm-ls-nonpegawai-tolak-form.component.html',
  styleUrls: ['./spm-ls-nonpegawai-tolak-form.component.scss']
})
export class SpmLsNonpegawaiTolakFormComponent implements OnInit {
