...
@Component({
  selector: 'app-spm-ls-nonpegawai-pajaktolak',
  templateUrl: './spm-ls-nonpegawai-pajaktolak.component.html',
  styleUrls: ['./spm-ls-nonpegawai-pajaktolak.component.scss']
})
export class SpmLsNonpegawaiPajaktolakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
