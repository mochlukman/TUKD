...
@Component({
  selector: 'app-lpj-pengesahan-rincian-lpj',
  templateUrl: './lpj-pengesahan-rincian-lpj.component.html',
  styleUrls: ['./lpj-pengesahan-rincian-lpj.component.scss']
})
export class LpjPengesahanRincianLpjComponent implements OnInit {
  title: String;
  spjSelected: ISpj;
  showThis: boolean;
  msg: Message[];
