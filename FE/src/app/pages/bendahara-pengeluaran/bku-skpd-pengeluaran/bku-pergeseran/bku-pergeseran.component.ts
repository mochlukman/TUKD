...
import { BkuPergeseranFormComponent } from './bku-pergeseran-form/bku-pergeseran-form.component';

@Component({
  selector: 'app-bku-pergeseran',
  templateUrl: './bku-pergeseran.component.html',
  styleUrls: ['./bku-pergeseran.component.scss']
})
export class BkuPergeseranComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(BkuPergeseranFormComponent, {static: true}) Form: BkuPergeseranFormComponent;
  constructor(
      ...
      this.service.generateNoBku(this.formFilter.value.idunit, this.formFilter.value.idbend)
        .subscribe(resp => {
          if(resp.nobku){
            ...
            this.Form.title = 'Tambah BKU Pergeseran';
            this.Form.mode = 'add';
