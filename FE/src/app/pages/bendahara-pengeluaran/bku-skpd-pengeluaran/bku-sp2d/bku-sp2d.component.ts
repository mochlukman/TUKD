...
import { BkuSp2dFormComponent } from './bku-sp2d-form/bku-sp2d-form.component';

@Component({
  selector: 'app-bku-sp2d',
  templateUrl: './bku-sp2d.component.html',
  styleUrls: ['./bku-sp2d.component.scss']
})
export class BkuSp2dComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(BkuSp2dFormComponent, {static: true}) Form: BkuSp2dFormComponent;
  constructor(
      ...
      this.service.generateNoBku(this.formFilter.value.idunit, this.formFilter.value.idbend)
        .subscribe(resp => {
          if(resp.nobku){
            ...
            this.Form.title = 'Tambah BKU SP2D';
            this.Form.mode = 'add';
