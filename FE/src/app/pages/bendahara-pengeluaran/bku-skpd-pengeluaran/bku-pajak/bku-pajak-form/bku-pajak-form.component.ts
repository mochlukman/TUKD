...
import { LookBkpajakComponent } from 'src/app/shared/lookups/look-bkpajak/look-bkpajak.component';

@Component({
  selector: 'app-bku-pajak-form',
  templateUrl: './bku-pajak-form.component.html',
  styleUrls: ['./bku-pajak-form.component.scss']
})
export class BkuPajakFormComponent implements OnInit {
  showThis: boolean;
  ...
  @ViewChild(LookBkpajakComponent,{static: true}) ref: LookBkpajakComponent;
  constructor(
