...
@Component({
  selector: 'app-bku-pelimpahan-form',
  templateUrl: './bku-pelimpahan-form.component.html',
  styleUrls: ['./bku-pelimpahan-form.component.scss']
})
export class BkuPelimpahanFormComponent implements OnInit {
  showThis: boolean;
  ...
  lookRef(){
    this.ref.title = 'Pilih TBP / Pelimpahan';
