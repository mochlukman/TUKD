...
@Component({
  selector: 'app-tab-pajak-transfer-form',
  templateUrl: './tab-pajak-transfer-form.component.html',
  styleUrls: ['./tab-pajak-transfer-form.component.scss']
})
export class TabPajakTransferFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('40')
      .subscribe(resp => {
