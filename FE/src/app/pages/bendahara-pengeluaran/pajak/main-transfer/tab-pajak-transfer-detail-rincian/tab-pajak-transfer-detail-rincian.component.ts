...
import { TabPajakTransferDetailRincianFormComponent } from '../tab-pajak-transfer-detail-rincian-form/tab-pajak-transfer-detail-rincian-form.component';

@Component({
  selector: 'app-tab-pajak-transfer-detail-rincian',
  templateUrl: './tab-pajak-transfer-detail-rincian.component.html',
  styleUrls: ['./tab-pajak-transfer-detail-rincian.component.scss']
})
export class TabPajakTransferDetailRincianComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
  listdata: IBkpajakdetstr[] = [];
  cols: any[] = [];
  @Input() bkpajakSelected : IBkpajak;
  userInfo: ITokenClaim;
  @ViewChild(TabPajakTransferDetailRincianFormComponent, {static: true}) Form : TabPajakTransferDetailRincianFormComponent;
  ...
  constructor(
    ...
    this.cols = [
      {field: 'idpajakNavigation.kdpajak'},
      {field: 'idpajakNavigation.nmpajak'},
      {field: 'idbilling'},
      {field: 'ntpn'},
      {field: 'ntb'},
      {field: 'pilih'}
