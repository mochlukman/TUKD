...
import { PelbankBpToBpFormComponent } from './pelbank-bp-to-bp-form/pelbank-bp-to-bp-form.component';

@Component({
  selector: 'app-pelbank-bp-to-bp',
  templateUrl: './pelbank-bp-to-bp.component.html',
  styleUrls: ['./pelbank-bp-to-bp.component.scss']
})
export class PelbankBpToBpComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(PelbankBpToBpFormComponent, {static: true}) Form: PelbankBpToBpFormComponent;
  ...
  add(){
    if(this.unitSelected && this.bendSelected){
      this.Form.title = 'Tambah Pelimpahan Bank (BP-BP)';
      this.Form.mode = 'add';
