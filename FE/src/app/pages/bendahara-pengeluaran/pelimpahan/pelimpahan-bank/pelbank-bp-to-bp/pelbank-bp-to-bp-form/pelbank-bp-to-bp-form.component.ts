...
@Component({
  selector: 'app-pelbank-bp-to-bp-form',
  templateUrl: './pelbank-bp-to-bp-form.component.html',
  styleUrls: ['./pelbank-bp-to-bp-form.component.scss']
})
export class PelbankBpToBpFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('54')
      .subscribe(resp => {
