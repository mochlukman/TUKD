...
@Component({
  selector: 'app-pelbank-bp-to-bp-detail-perima-form',
  templateUrl: './pelbank-bp-to-bp-detail-perima-form.component.html',
  styleUrls: ['./pelbank-bp-to-bp-detail-perima-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PelbankBpToBpDetailPerimaFormComponent implements OnInit {
