...
@Component({
  selector: 'app-pelbank-bpp-to-bp-kegiatan-form',
  templateUrl: './pelbank-bpp-to-bp-kegiatan-form.component.html',
  styleUrls: ['./pelbank-bpp-to-bp-kegiatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PelbankBppToBpKegiatanFormComponent implements OnInit {
