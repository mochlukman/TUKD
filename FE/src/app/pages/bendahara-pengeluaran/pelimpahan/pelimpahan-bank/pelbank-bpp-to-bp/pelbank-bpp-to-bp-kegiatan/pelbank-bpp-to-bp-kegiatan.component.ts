...
import { PelbankBppToBpKegiatanFormComponent } from '../pelbank-bpp-to-bp-kegiatan-form/pelbank-bpp-to-bp-kegiatan-form.component';

@Component({
  selector: 'app-pelbank-bpp-to-bp-kegiatan',
  templateUrl: './pelbank-bpp-to-bp-kegiatan.component.html',
  styleUrls: ['./pelbank-bpp-to-bp-kegiatan.component.scss']
})
export class PelbankBppToBpKegiatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PelbankBppToBpKegiatanFormComponent,{static: true}) Form : PelbankBppToBpKegiatanFormComponent;
