...
import { PelbankBppToBpDetailPerimaFormComponent } from '../pelbank-bpp-to-bp-detail-perima-form/pelbank-bpp-to-bp-detail-perima-form.component';

@Component({
  selector: 'app-pelbank-bpp-to-bp-detail-perima',
  templateUrl: './pelbank-bpp-to-bp-detail-perima.component.html',
  styleUrls: ['./pelbank-bpp-to-bp-detail-perima.component.scss']
})
export class PelbankBppToBpDetailPerimaComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PelbankBppToBpDetailPerimaFormComponent, {static: true}) Form : PelbankBppToBpDetailPerimaFormComponent;
