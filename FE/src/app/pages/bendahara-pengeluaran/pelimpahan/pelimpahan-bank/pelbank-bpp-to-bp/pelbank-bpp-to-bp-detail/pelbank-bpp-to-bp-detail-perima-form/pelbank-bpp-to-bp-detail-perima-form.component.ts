...
@Component({
  selector: 'app-pelbank-bpp-to-bp-detail-perima-form',
  templateUrl: './pelbank-bpp-to-bp-detail-perima-form.component.html',
  styleUrls: ['./pelbank-bpp-to-bp-detail-perima-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PelbankBppToBpDetailPerimaFormComponent implements OnInit {
