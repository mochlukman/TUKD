...
@Component({
  selector: 'app-pelbank-bp-to-bpp-form',
  templateUrl: './pelbank-bp-to-bpp-form.component.html',
  styleUrls: ['./pelbank-bp-to-bpp-form.component.scss']
})
export class PelbankBpToBppFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('37')
      .subscribe(resp => {
