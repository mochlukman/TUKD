...
@Component({
  selector: 'app-pelbank-bp-to-bpp-detail-perima-form',
  templateUrl: './pelbank-bp-to-bpp-detail-perima-form.component.html',
  styleUrls: ['./pelbank-bp-to-bpp-detail-perima-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PelbankBpToBppDetailPerimaFormComponent implements OnInit {
