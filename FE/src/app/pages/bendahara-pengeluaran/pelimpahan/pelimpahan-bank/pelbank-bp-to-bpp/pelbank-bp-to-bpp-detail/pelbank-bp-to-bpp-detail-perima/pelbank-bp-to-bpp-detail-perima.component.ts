...
import { PelbankBpToBppDetailPerimaFormComponent } from '../pelbank-bp-to-bpp-detail-perima-form/pelbank-bp-to-bpp-detail-perima-form.component';

@Component({
  selector: 'app-pelbank-bp-to-bpp-detail-perima',
  templateUrl: './pelbank-bp-to-bpp-detail-perima.component.html',
  styleUrls: ['./pelbank-bp-to-bpp-detail-perima.component.scss']
})
export class PelbankBpToBppDetailPerimaComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PelbankBpToBppDetailPerimaFormComponent, {static: true}) Form : PelbankBpToBppDetailPerimaFormComponent;
