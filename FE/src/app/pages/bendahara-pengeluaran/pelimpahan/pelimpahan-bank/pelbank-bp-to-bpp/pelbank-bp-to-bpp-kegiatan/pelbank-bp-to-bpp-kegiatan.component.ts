...
import { PelbankBpToBppKegiatanFormComponent } from '../pelbank-bp-to-bpp-kegiatan-form/pelbank-bp-to-bpp-kegiatan-form.component';

@Component({
  selector: 'app-pelbank-bp-to-bpp-kegiatan',
  templateUrl: './pelbank-bp-to-bpp-kegiatan.component.html',
  styleUrls: ['./pelbank-bp-to-bpp-kegiatan.component.scss']
})
export class PelbankBpToBppKegiatanComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(PelbankBpToBppKegiatanFormComponent,{static: true}) Form : PelbankBpToBppKegiatanFormComponent;
