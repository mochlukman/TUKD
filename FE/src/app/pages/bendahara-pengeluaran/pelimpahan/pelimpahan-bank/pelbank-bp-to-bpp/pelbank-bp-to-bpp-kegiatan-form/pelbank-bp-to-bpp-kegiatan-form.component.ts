...
@Component({
  selector: 'app-pelbank-bp-to-bpp-kegiatan-form',
  templateUrl: './pelbank-bp-to-bpp-kegiatan-form.component.html',
  styleUrls: ['./pelbank-bp-to-bpp-kegiatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PelbankBpToBppKegiatanFormComponent implements OnInit {
