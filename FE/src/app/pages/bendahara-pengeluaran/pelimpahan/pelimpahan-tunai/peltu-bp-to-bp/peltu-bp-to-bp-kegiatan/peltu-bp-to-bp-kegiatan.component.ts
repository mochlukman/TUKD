...
import { PeltuBpToBpKegiatanFormComponent } from '../peltu-bp-to-bp-kegiatan-form/peltu-bp-to-bp-kegiatan-form.component';

@Component({
  selector: 'app-peltu-bp-to-bp-kegiatan',
  templateUrl: './peltu-bp-to-bp-kegiatan.component.html',
  styleUrls: ['./peltu-bp-to-bp-kegiatan.component.scss']
})
export class PeltuBpToBpKegiatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PeltuBpToBpKegiatanFormComponent,{static: true}) Form : PeltuBpToBpKegiatanFormComponent;
