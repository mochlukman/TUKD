...
import { PeltuBpToBpDetailPenerimaFormComponent } from '../peltu-bp-to-bp-detail-penerima-form/peltu-bp-to-bp-detail-penerima-form.component';

@Component({
  selector: 'app-peltu-bp-to-bp-detail-penerima',
  templateUrl: './peltu-bp-to-bp-detail-penerima.component.html',
  styleUrls: ['./peltu-bp-to-bp-detail-penerima.component.scss']
})
export class PeltuBpToBpDetailPenerimaComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PeltuBpToBpDetailPenerimaFormComponent, {static: true}) Form : PeltuBpToBpDetailPenerimaFormComponent;
