...
@Component({
  selector: 'app-peltu-bp-to-bp-kegiatan-form',
  templateUrl: './peltu-bp-to-bp-kegiatan-form.component.html',
  styleUrls: ['./peltu-bp-to-bp-kegiatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PeltuBpToBpKegiatanFormComponent implements OnInit {
