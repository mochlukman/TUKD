...
@Component({
  selector: 'app-peltu-bp-to-bp-detail',
  templateUrl: './peltu-bp-to-bp-detail.component.html',
  styleUrls: ['./peltu-bp-to-bp-detail.component.scss']
})
export class PeltuBpToBpDetailComponent implements OnInit, OnDestroy, OnChanges {
  tabIndex: number = 0;
