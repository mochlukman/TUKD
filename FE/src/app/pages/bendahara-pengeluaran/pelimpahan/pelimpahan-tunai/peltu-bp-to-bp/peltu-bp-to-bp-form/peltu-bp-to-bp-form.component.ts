...
@Component({
  selector: 'app-peltu-bp-to-bp-form',
  templateUrl: './peltu-bp-to-bp-form.component.html',
  styleUrls: ['./peltu-bp-to-bp-form.component.scss']
})
export class PeltuBpToBpFormComponent implements OnInit {
  showThis: boolean;
