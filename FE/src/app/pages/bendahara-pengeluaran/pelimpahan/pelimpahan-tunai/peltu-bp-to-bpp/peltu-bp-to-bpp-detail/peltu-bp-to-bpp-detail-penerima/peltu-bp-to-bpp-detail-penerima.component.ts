...
import { PeltuBpToBppDetailPenerimaFormComponent } from '../peltu-bp-to-bpp-detail-penerima-form/peltu-bp-to-bpp-detail-penerima-form.component';

@Component({
  selector: 'app-peltu-bp-to-bpp-detail-penerima',
  templateUrl: './peltu-bp-to-bpp-detail-penerima.component.html',
  styleUrls: ['./peltu-bp-to-bpp-detail-penerima.component.scss']
})
export class PeltuBpToBppDetailPenerimaComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
  cols: any[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PeltuBpToBppDetailPenerimaFormComponent, {static: true}) Form : PeltuBpToBppDetailPenerimaFormComponent;
  ...
  constructor(
    ...
    this.cols = [
      {field: 'idbendNavigation.idpegNavigation.nama'},
      {field: 'idbendNavigation.rekbend'},
      {field: 'nilai'},
      {field: 'pilih'}
    ];
