...
import { PeltuBpToBppDetailPenerimaFormComponent } from '../peltu-bp-to-bpp-detail/peltu-bp-to-bpp-detail-penerima-form/peltu-bp-to-bpp-detail-penerima-form.component';
import { PeltuBpToBppKegiatanFormComponent } from '../peltu-bp-to-bpp-kegiatan-form/peltu-bp-to-bpp-kegiatan-form.component';

@Component({
  selector: 'app-peltu-bp-to-bpp-kegiatan',
  templateUrl: './peltu-bp-to-bpp-kegiatan.component.html',
  styleUrls: ['./peltu-bp-to-bpp-kegiatan.component.scss']
})
export class PeltuBpToBppKegiatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PeltuBpToBppKegiatanFormComponent,{static: true}) Form : PeltuBpToBppDetailPenerimaFormComponent;
