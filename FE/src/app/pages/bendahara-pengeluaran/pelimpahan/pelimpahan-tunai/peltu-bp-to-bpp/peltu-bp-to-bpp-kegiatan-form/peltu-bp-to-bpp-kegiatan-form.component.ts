...
@Component({
  selector: 'app-peltu-bp-to-bpp-kegiatan-form',
  templateUrl: './peltu-bp-to-bpp-kegiatan-form.component.html',
  styleUrls: ['./peltu-bp-to-bpp-kegiatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PeltuBpToBppKegiatanFormComponent implements OnInit {
