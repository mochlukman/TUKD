...
@Component({
  selector: 'app-peltu-bp-to-bpp-detail-penerima-form',
  templateUrl: './peltu-bp-to-bpp-detail-penerima-form.component.html',
  styleUrls: ['./peltu-bp-to-bpp-detail-penerima-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PeltuBpToBppDetailPenerimaFormComponent implements OnInit {
