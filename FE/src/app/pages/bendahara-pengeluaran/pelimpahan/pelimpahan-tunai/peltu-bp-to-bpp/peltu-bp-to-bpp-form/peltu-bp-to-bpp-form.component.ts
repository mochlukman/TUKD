...
@Component({
  selector: 'app-peltu-bp-to-bpp-form',
  templateUrl: './peltu-bp-to-bpp-form.component.html',
  styleUrls: ['./peltu-bp-to-bpp-form.component.scss']
})
export class PeltuBpToBppFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('38')
      .subscribe(resp => {
