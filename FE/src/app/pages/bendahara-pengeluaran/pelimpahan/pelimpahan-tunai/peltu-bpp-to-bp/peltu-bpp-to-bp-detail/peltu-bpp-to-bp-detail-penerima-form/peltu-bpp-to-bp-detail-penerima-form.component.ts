...
@Component({
  selector: 'app-peltu-bpp-to-bp-detail-penerima-form',
  templateUrl: './peltu-bpp-to-bp-detail-penerima-form.component.html',
  styleUrls: ['./peltu-bpp-to-bp-detail-penerima-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PeltuBppToBpDetailPenerimaFormComponent implements OnInit {
