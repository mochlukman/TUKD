...
@Component({
  selector: 'app-peltu-bpp-to-bp-kegiatan-form',
  templateUrl: './peltu-bpp-to-bp-kegiatan-form.component.html',
  styleUrls: ['./peltu-bpp-to-bp-kegiatan-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PeltuBppToBpKegiatanFormComponent implements OnInit {
