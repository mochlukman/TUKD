...
@Component({
  selector: 'app-peltu-bpp-to-bp-form',
  templateUrl: './peltu-bpp-to-bp-form.component.html',
  styleUrls: ['./peltu-bpp-to-bp-form.component.scss']
})
export class PeltuBppToBpFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('52')
      .subscribe(resp => {
