...
import { PeltuBppToBpKegiatanFormComponent } from '../peltu-bpp-to-bp-kegiatan-form/peltu-bpp-to-bp-kegiatan-form.component';

@Component({
  selector: 'app-peltu-bpp-to-bp-kegiatan',
  templateUrl: './peltu-bpp-to-bp-kegiatan.component.html',
  styleUrls: ['./peltu-bpp-to-bp-kegiatan.component.scss']
})
export class PeltuBppToBpKegiatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PeltuBppToBpKegiatanFormComponent,{static: true}) Form : PeltuBppToBpKegiatanFormComponent;
  ...
  constructor(
    ...
    this.cols = [
      {field: 'idkegNavigation.nukeg'},
      {field: 'idkegNavigation.nmkegunit'},
      {field: 'nilai'},
      {field: 'pilih'}
    ]
  }
