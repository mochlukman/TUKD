...
import { PeltuBppToBpDetailPenerimaFormComponent } from '../peltu-bpp-to-bp-detail-penerima-form/peltu-bpp-to-bp-detail-penerima-form.component';

@Component({
  selector: 'app-peltu-bpp-to-bp-detail-penerima',
  templateUrl: './peltu-bpp-to-bp-detail-penerima.component.html',
  styleUrls: ['./peltu-bpp-to-bp-detail-penerima.component.scss']
})
export class PeltuBppToBpDetailPenerimaComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: ITbpdett[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PeltuBppToBpDetailPenerimaFormComponent, {static: true}) Form : PeltuBppToBpDetailPenerimaFormComponent;
