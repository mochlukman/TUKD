...
@Component({
  selector: 'app-pembuatan-bpk-form',
  templateUrl: './pembuatan-bpk-form.component.html',
  styleUrls: ['./pembuatan-bpk-form.component.scss']
})
export class PembuatanBpkFormComponent implements OnInit {
  showThis: boolean;
