...
import { PembuatanBpkFormComponent } from './pembuatan-bpk-form/pembuatan-bpk-form.component';

@Component({
  selector: 'app-pembuatan-bpk',
  templateUrl: './pembuatan-bpk.component.html',
  styleUrls: ['./pembuatan-bpk.component.scss']
})
export class PembuatanBpkComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PembuatanBpkFormComponent, {static: true}) Form: PembuatanBpkFormComponent;
