...
@Component({
  selector: 'app-pengesahan-bpk-form',
  templateUrl: './pengesahan-bpk-form.component.html',
  styleUrls: ['./pengesahan-bpk-form.component.scss']
})
export class PengesahanBpkFormComponent implements OnInit {
  showThis: boolean;
