...
import { PembuatanBpkKoreksiFormComponent } from './pembuatan-bpk-koreksi-form/pembuatan-bpk-koreksi-form.component';

@Component({
  selector: 'app-pembuatan-bpk-koreksi',
  templateUrl: './pembuatan-bpk-koreksi.component.html',
  styleUrls: ['./pembuatan-bpk-koreksi.component.scss']
})
export class PembuatanBpkKoreksiComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(PembuatanBpkKoreksiFormComponent, {static: true}) Form: PembuatanBpkKoreksiFormComponent;
