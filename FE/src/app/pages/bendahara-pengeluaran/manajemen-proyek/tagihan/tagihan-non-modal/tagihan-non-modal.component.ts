...
@Component({
  selector: 'app-tagihan-non-modal',
  templateUrl: './tagihan-non-modal.component.html',
  styleUrls: ['./tagihan-non-modal.component.scss']
})
export class TagihanNonModalComponent implements OnInit, OnDestroy {
