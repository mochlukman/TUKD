...
import { AkunPendapatanFormComponent } from './akun-pendapatan-form/akun-pendapatan-form.component';

@Component({
  selector: 'app-akun-pendapatan',
  templateUrl: './akun-pendapatan.component.html',
  styleUrls: ['./akun-pendapatan.component.scss']
})
export class AkunPendapatanComponent implements OnInit, OnChanges, OnDestroy {
  @Input() tabIndex: number = 0;
  loading: boolean;
  listdata: IDaftrekening[] = [];
  userInfo: ITokenClaim;
  @ViewChild('dt', {static:false}) dt: any;
  @ViewChild(AkunPendapatanFormComponent, {static: true}) Form: AkunPendapatanFormComponent;
  constructor(
