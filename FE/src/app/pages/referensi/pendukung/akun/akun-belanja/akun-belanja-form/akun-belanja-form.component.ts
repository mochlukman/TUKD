...
@Component({
  selector: 'app-akun-belanja-form',
  templateUrl: './akun-belanja-form.component.html',
  styleUrls: ['./akun-belanja-form.component.scss']
})
export class AkunBelanjaFormComponent implements OnInit {
  ...
  getJnsakun(){
    this.loading_post = true;
    this.listJnsakun = []
    this.jnsakunService._idjnsakun = '7,8';
