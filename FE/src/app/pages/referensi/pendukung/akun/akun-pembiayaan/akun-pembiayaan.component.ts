...
import { AkunPembiayaanFormComponent } from './akun-pembiayaan-form/akun-pembiayaan-form.component';

@Component({
  selector: 'app-akun-pembiayaan',
  templateUrl: './akun-pembiayaan.component.html',
  styleUrls: ['./akun-pembiayaan.component.scss']
})
export class AkunPembiayaanComponent implements OnInit, OnChanges, OnDestroy {
  @Input() tabIndex: number = 0;
  loading: boolean;
  listdata: IDaftrekening[] = [];
  userInfo: ITokenClaim;
  @ViewChild('dt', {static:false}) dt: any;
  @ViewChild(AkunPembiayaanFormComponent, {static: true}) Form: AkunPembiayaanFormComponent;
  constructor(
