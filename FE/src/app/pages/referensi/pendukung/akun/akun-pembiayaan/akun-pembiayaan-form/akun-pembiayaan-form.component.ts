...
@Component({
  selector: 'app-akun-pembiayaan-form',
  templateUrl: './akun-pembiayaan-form.component.html',
  styleUrls: ['./akun-pembiayaan-form.component.scss']
})
export class AkunPembiayaanFormComponent implements OnInit {
  ...
  getJnsakun(){
    this.loading_post = true;
    this.listJnsakun = []
    this.jnsakunService._idjnsakun = '1,2,3';
