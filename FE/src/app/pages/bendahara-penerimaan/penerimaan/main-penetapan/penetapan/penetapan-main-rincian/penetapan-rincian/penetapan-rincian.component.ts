...
import { PenetapanRincianFormComponent } from '../penetapan-rincian-form/penetapan-rincian-form.component';

@Component({
  selector: 'app-penetapan-rincian',
  templateUrl: './penetapan-rincian.component.html',
  styleUrls: ['./penetapan-rincian.component.scss']
})
export class PenetapanRincianComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: ITbpdetd[] = [];
  @Input() TbpSelected : ITbp;
  userInfo: ITokenClaim;
  @ViewChild(PenetapanRincianFormComponent, {static: true}) Form : PenetapanRincianFormComponent;
