...
@Component({
  selector: 'app-tanpa-penetapan-rincian-form',
  templateUrl: './tanpa-penetapan-rincian-form.component.html',
  styleUrls: ['./tanpa-penetapan-rincian-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class TanpaPenetapanRincianFormComponent implements OnInit {
