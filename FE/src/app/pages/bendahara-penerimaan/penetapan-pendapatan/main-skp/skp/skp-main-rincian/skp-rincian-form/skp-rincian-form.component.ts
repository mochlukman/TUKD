...
@Component({
  selector: 'app-skp-rincian-form',
  templateUrl: './skp-rincian-form.component.html',
  styleUrls: ['./skp-rincian-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class SkpRincianFormComponent implements OnInit {
