...
@Component({
  selector: 'app-dpengajuan-form',
  templateUrl: './dpengajuan-form.component.html',
  styleUrls: ['./dpengajuan-form.component.scss']
})
export class DPengajuanFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('16,60,61,63,64')
      .subscribe(resp => {
