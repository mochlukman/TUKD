...
@Component({
  selector: 'app-bpengajuan-form',
  templateUrl: './bpengajuan-form.component.html',
  styleUrls: ['./bpengajuan-form.component.scss']
})
export class BPengajuanFormComponent implements OnInit {
  showThis: boolean;
  ...
  getStattrs(){
    ...
    this.stattrsService.getBylist('16')
      .subscribe(resp => {
