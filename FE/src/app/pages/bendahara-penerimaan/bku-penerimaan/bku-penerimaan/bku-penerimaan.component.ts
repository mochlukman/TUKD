...
import { BkuPenerimaanFormComponent } from './bku-penerimaan-form/bku-penerimaan-form.component';

@Component({
  selector: 'app-bku-penerimaan',
  templateUrl: './bku-penerimaan.component.html',
  styleUrls: ['./bku-penerimaan.component.scss']
})
export class BkuPenerimaanComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(BkuPenerimaanFormComponent, {static: true}) Form: BkuPenerimaanFormComponent;
  constructor(
