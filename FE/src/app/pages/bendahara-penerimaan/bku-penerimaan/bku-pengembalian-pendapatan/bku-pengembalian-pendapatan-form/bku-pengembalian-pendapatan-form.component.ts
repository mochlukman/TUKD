...
@Component({
  selector: 'app-bku-pengembalian-pendapatan-form',
  templateUrl: './bku-pengembalian-pendapatan-form.component.html',
  styleUrls: ['./bku-pengembalian-pendapatan-form.component.scss']
})
export class BkuPengembalianPendapatanFormComponent implements OnInit {
  showThis: boolean;
