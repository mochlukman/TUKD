...
@Component({
  selector: 'app-kartukendali-subkegiatan',
  templateUrl: './kartukendali-subkegiatan.component.html',
  styleUrls: ['./kartukendali-subkegiatan.component.scss']
})
export class KartukendaliSubkegiatanComponent implements OnInit , OnDestroy {
