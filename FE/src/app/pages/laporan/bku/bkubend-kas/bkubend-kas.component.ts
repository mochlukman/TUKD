...
@Component({
  selector: 'app-bkubend-kas',
  templateUrl: './bkubend-kas.component.html',
  styleUrls: ['./bkubend-kas.component.scss']
})
export class BkubendKasComponent implements OnInit , OnDestroy {
