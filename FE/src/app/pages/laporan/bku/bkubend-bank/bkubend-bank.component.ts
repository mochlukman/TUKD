...
@Component({
  selector: 'app-bkubend-bank',
  templateUrl: './bkubend-bank.component.html',
  styleUrls: ['./bkubend-bank.component.scss']
})
export class BkubendBankComponent implements OnInit , OnDestroy {
