...
@Component({
  selector: 'app-bkubend-pajak',
  templateUrl: './bkubend-pajak.component.html',
  styleUrls: ['./bkubend-pajak.component.scss']
})
export class BkubendPajakComponent implements OnInit , OnDestroy {
