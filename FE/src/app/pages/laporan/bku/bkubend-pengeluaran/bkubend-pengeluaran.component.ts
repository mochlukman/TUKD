...
@Component({
  selector: 'app-bkubend-pengeluaran',
  templateUrl: './bkubend-pengeluaran.component.html',
  styleUrls: ['./bkubend-pengeluaran.component.scss']
})
export class BkubendPengeluaranComponent implements OnInit , OnDestroy {
