...
@Component({
  selector: 'app-apbdringkasan',
  templateUrl: './apbdringkasan.component.html',
  styleUrls: ['./apbdringkasan.component.scss']
})
export class ApbdringkasanComponent implements OnInit , OnDestroy {
