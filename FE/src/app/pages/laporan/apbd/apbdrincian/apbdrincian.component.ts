...
@Component({
  selector: 'app-apbdrincian',
  templateUrl: './apbdrincian.component.html',
  styleUrls: ['./apbdrincian.component.scss']
})
export class ApbdrincianComponent implements OnInit, OnDestroy {
