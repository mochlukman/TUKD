...
@Component({
  selector: 'app-penjabaran-ringkasan',
  templateUrl: './penjabaran-ringkasan.component.html',
  styleUrls: ['./penjabaran-ringkasan.component.scss']
})
export class PenjabaranRingkasanComponent implements OnInit , OnDestroy {
