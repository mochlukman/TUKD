...
@Component({
  selector: 'app-lap-penerimaan',
  templateUrl: './lap-penerimaan.component.html',
  styleUrls: ['./lap-penerimaan.component.scss']
})
export class LapPenerimaanComponent implements OnInit , OnDestroy {
