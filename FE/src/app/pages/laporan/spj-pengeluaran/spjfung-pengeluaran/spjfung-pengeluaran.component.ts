...
@Component({
  selector: 'app-spjfung-pengeluaran',
  templateUrl: './spjfung-pengeluaran.component.html',
  styleUrls: ['./spjfung-pengeluaran.component.scss']
})
export class SpjfungPengeluaranComponent implements OnInit , OnDestroy {
