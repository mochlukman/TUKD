...
@Component({
  selector: 'app-spjadm-pengeluaran',
  templateUrl: './spjadm-pengeluaran.component.html',
  styleUrls: ['./spjadm-pengeluaran.component.scss']
})
export class SpjadmPengeluaranComponent implements OnInit , OnDestroy {
