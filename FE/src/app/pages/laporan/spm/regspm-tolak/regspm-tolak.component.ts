...
@Component({
  selector: 'app-regspm-tolak',
  templateUrl: './regspm-tolak.component.html',
  styleUrls: ['./regspm-tolak.component.scss']
})
export class RegspmTolakComponent implements OnInit , OnDestroy {
