...
@Component({
  selector: 'app-spm-tolak',
  templateUrl: './spm-tolak.component.html',
  styleUrls: ['./spm-tolak.component.scss']
})
export class SpmTolakComponent implements OnInit, OnDestroy {
