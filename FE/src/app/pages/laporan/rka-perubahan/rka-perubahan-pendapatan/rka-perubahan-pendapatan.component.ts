...
@Component({
  selector: 'app-rka-perubahan-pendapatan',
  templateUrl: './rka-perubahan-pendapatan.component.html',
  styleUrls: ['./rka-perubahan-pendapatan.component.scss']
})
export class RkaPerubahanPendapatanComponent implements OnInit, OnDestroy {
