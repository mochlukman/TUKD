...
@Component({
  selector: 'app-rka-perubahan-ringkasan',
  templateUrl: './rka-perubahan-ringkasan.component.html',
  styleUrls: ['./rka-perubahan-ringkasan.component.scss']
})
export class RkaPerubahanRingkasanComponent implements OnInit, OnDestroy {
