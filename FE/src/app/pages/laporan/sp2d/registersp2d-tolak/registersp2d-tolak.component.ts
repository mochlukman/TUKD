...
@Component({
  selector: 'app-registersp2d-tolak',
  templateUrl: './registersp2d-tolak.component.html',
  styleUrls: ['./registersp2d-tolak.component.scss']
})
export class Registersp2dTolakComponent implements OnInit , OnDestroy {
