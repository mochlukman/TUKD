...
@Component({
  selector: 'app-registerspp-spm-sp2d',
  templateUrl: './registerspp-spm-sp2d.component.html',
  styleUrls: ['./registerspp-spm-sp2d.component.scss']
})
export class RegistersppSpmSp2dComponent implements OnInit , OnDestroy {
