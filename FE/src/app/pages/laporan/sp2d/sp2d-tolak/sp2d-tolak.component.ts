...
@Component({
  selector: 'app-sp2d-tolak',
  templateUrl: './sp2d-tolak.component.html',
  styleUrls: ['./sp2d-tolak.component.scss']
})
export class Sp2dTolakComponent implements OnInit, OnDestroy {
