...
@Component({
  selector: 'app-spp-turencana',
  templateUrl: './spp-turencana.component.html',
  styleUrls: ['./spp-turencana.component.scss']
})
export class SppTurencanaComponent implements OnInit, OnDestroy {
