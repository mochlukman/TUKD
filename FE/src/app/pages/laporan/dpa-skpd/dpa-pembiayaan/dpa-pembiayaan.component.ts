...
@Component({
  selector: 'app-dpa-pembiayaan',
  templateUrl: './dpa-pembiayaan.component.html',
  styleUrls: ['./dpa-pembiayaan.component.scss']
})
export class DpaPembiayaanComponent implements OnInit, OnDestroy {
