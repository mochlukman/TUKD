...
@Component({
  selector: 'app-dpa-rincian',
  templateUrl: './dpa-rincian.component.html',
  styleUrls: ['./dpa-rincian.component.scss']
})
export class DpaRincianComponent implements OnInit, OnDestroy {
  ...
  lookKegiatan(){
    if(this.unitSelected){
      ...
      this.Kegiatan.get(this.unitSelected.idunit, '321',true);
