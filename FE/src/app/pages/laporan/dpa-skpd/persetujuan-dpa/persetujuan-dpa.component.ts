...
@Component({
  selector: 'app-persetujuan-dpa',
  templateUrl: './persetujuan-dpa.component.html',
  styleUrls: ['./persetujuan-dpa.component.scss']
})
export class PersetujuanDpaComponent implements OnInit, OnDestroy {
