...
@Component({
  selector: 'app-dpa-pendapatan',
  templateUrl: './dpa-pendapatan.component.html',
  styleUrls: ['./dpa-pendapatan.component.scss']
})
export class DpaPendapatanComponent implements OnInit, OnDestroy {
