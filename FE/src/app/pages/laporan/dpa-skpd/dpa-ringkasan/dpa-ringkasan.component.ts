...
@Component({
  selector: 'app-dpa-ringkasan',
  templateUrl: './dpa-ringkasan.component.html',
  styleUrls: ['./dpa-ringkasan.component.scss']
})
export class DpaRingkasanComponent implements OnInit, OnDestroy {
