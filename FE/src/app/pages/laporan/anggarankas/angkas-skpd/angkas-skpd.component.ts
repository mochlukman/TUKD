...
@Component({
  selector: 'app-angkas-skpd',
  templateUrl: './angkas-skpd.component.html',
  styleUrls: ['./angkas-skpd.component.scss']
})
export class AngkasSkpdComponent implements OnInit, OnDestroy {
