...
@Component({
  selector: 'app-bkubend-penerimaan',
  templateUrl: './bkubend-penerimaan.component.html',
  styleUrls: ['./bkubend-penerimaan.component.scss']
})
export class BkubendPenerimaanComponent implements OnInit , OnDestroy {
