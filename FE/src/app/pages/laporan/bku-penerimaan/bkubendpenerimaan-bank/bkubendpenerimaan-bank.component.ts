...
@Component({
  selector: 'app-bkubendpenerimaan-bank',
  templateUrl: './bkubendpenerimaan-bank.component.html',
  styleUrls: ['./bkubendpenerimaan-bank.component.scss']
})
export class BkubendpenerimaanBankComponent implements OnInit, OnDestroy {
  ...
  lookBendahara(){
    if(this.unitSelected){
      ...
      this.Bendahara.gets(this.unitSelected.idunit, '01'); //01 = jnsbend, bendahara penerimaan
    ...
    if(e.cetak){
			if (!this.unitSelected) {
				...
				this.parameterReport = {
					...
					FileName: 'SIMBANKPENERIMAAN.rpt',
					Params: {
