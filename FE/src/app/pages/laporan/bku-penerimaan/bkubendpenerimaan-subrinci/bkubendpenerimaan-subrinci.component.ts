...
import { LookDaftrekBystsdetdComponent } from 'src/app/shared/lookups/look-daftrek-bystsdetd/look-daftrek-bystsdetd.component';

@Component({
  selector: 'app-bkubendpenerimaan-subrinci',
  templateUrl: './bkubendpenerimaan-subrinci.component.html',
  styleUrls: ['./bkubendpenerimaan-subrinci.component.scss']
})
export class BkubendpenerimaanSubrinciComponent implements OnInit , OnDestroy {
  ...
  @ViewChild(LookDaftrekBystsdetdComponent, {static: true}) Daftrek : LookDaftrekBystsdetdComponent;
  ...
  lookDaftrek(){
    if(this.unitSelected){
      ...
      this.Daftrek._idunit = this.unitSelected.idunit;
      this.Daftrek._idxkode=1;
      this.Daftrek.showThis=true;
    } else {
  ...
  callBackDaftrek(e: IDaftrekening){
    ...
    this.uiDaftrek = {
      kode: this.daftrekSelected.kdper, 
      nama: this.daftrekSelected.nmper
    };
  }
