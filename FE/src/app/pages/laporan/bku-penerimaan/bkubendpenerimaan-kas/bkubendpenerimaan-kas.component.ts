...
@Component({
  selector: 'app-bkubendpenerimaan-kas',
  templateUrl: './bkubendpenerimaan-kas.component.html',
  styleUrls: ['./bkubendpenerimaan-kas.component.scss']
})
export class BkubendpenerimaanKasComponent implements OnInit , OnDestroy {
    ...
    if(e.cetak){
			if (!this.unitSelected) {
				...
				this.parameterReport = {
					...
					FileName: 'KASTUNAIPENERIMAAN.rpt',
					Params: {
