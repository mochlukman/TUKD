...
@Component({
  selector: 'app-rka-ringkasan',
  templateUrl: './rka-ringkasan.component.html',
  styleUrls: ['./rka-ringkasan.component.scss']
})
export class RkaRingkasanComponent implements OnInit , OnDestroy {
