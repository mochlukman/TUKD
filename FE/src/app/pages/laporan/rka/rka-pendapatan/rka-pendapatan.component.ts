...
@Component({
  selector: 'app-rka-pendapatan',
  templateUrl: './rka-pendapatan.component.html',
  styleUrls: ['./rka-pendapatan.component.scss']
})
export class RkaPendapatanComponent implements OnInit, OnDestroy {
