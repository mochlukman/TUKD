...
@Component({
  selector: 'app-rka-rincian',
  templateUrl: './rka-rincian.component.html',
  styleUrls: ['./rka-rincian.component.scss']
})
export class RkaRincianComponent implements OnInit, OnDestroy {
  ...
  lookKegiatan(){
    if(this.unitSelected){
      ...
      this.Kegiatan._idunit = this.unitSelected.idunit;
      this.service._kdtahap = this.tahapSelected.kdtahap;
