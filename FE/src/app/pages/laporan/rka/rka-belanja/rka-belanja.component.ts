...
@Component({
  selector: 'app-rka-belanja',
  templateUrl: './rka-belanja.component.html',
  styleUrls: ['./rka-belanja.component.scss']
})
export class RkaBelanjaComponent implements OnInit, OnDestroy {
