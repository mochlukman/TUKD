...
@Component({
  selector: 'app-rkadetr-form',
  templateUrl: './rkadetr-form.component.html',
  styleUrls: ['./rkadetr-form.component.scss'],
  providers: [InputRupiahPipe]
})
export class RkadetrFormComponent implements OnInit {
