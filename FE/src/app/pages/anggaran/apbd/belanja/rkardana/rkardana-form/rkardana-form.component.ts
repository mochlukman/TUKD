...
@Component({
  selector: 'app-rkardana-form',
  templateUrl: './rkardana-form.component.html',
  styleUrls: ['./rkardana-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class RkardanaFormComponent implements OnInit {
