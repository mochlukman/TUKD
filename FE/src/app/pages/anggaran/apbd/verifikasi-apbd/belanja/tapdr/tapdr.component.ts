...
import { TapdrFormComponent } from './tapdr-form/tapdr-form.component';

@Component({
  selector: 'app-tapdr',
  templateUrl: './tapdr.component.html',
  styleUrls: ['./tapdr.component.scss']
})
export class TapdrComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapdrFormComponent, {static: true}) Form : TapdrFormComponent;
  constructor(
