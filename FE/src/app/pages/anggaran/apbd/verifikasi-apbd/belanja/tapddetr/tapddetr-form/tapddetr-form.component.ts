...
@Component({
  selector: 'app-tapddetr-form',
  templateUrl: './tapddetr-form.component.html',
  styleUrls: ['./tapddetr-form.component.scss']
})
export class TapddetrFormComponent implements OnInit {
  showThis: boolean;
