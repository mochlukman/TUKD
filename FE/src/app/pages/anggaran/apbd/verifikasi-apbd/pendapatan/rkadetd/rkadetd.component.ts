...
import { TapddetdComponent } from '../tapddetd/tapddetd.component';

@Component({
  selector: 'app-rkadetd',
  templateUrl: './rkadetd.component.html',
  styleUrls: ['./rkadetd.component.scss']
})
export class RkadetdComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: IRkadetd[] = [];
  ...
  @ViewChild(TapddetdComponent, {static: true}) Tapddet: TapddetdComponent;
