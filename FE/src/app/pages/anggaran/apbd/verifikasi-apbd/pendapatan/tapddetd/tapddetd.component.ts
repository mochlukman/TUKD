...
import { TapddetdFormComponent } from './tapddetd-form/tapddetd-form.component';

@Component({
  selector: 'app-tapddetd',
  templateUrl: './tapddetd.component.html',
  styleUrls: ['./tapddetd.component.scss']
})
export class TapddetdComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapddetdFormComponent, {static: true}) Form : TapddetdFormComponent;
  idunit: number = 0;
  constructor(
