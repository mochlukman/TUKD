...
import { TapdbFormComponent } from './tapdb-form/tapdb-form.component';

@Component({
  selector: 'app-tapdb',
  templateUrl: './tapdb.component.html',
  styleUrls: ['./tapdb.component.scss']
})
export class TapdbComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapdbFormComponent, {static: true}) Form : TapdbFormComponent;
  constructor(
