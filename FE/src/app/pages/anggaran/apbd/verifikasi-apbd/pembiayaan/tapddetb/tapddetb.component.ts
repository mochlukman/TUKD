...
import { TapddetbFormComponent } from './tapddetb-form/tapddetb-form.component';

@Component({
  selector: 'app-tapddetb',
  templateUrl: './tapddetb.component.html',
  styleUrls: ['./tapddetb.component.scss']
})
export class TapddetbComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapddetbFormComponent, {static: true}) Form : TapddetbFormComponent;
  idunit: number = 0;
  constructor(
