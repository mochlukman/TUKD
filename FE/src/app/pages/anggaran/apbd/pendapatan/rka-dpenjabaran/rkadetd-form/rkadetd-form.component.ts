...
@Component({
  selector: 'app-rkadetd-form',
  templateUrl: './rkadetd-form.component.html',
  styleUrls: ['./rkadetd-form.component.scss'],
  providers: [InputRupiahPipe]
})
export class RkadetdFormComponent implements OnInit {
