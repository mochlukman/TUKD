...
import { RkadetdFormComponent } from './rkadetd-form/rkadetd-form.component';

@Component({
  selector: 'app-rka-dpenjabaran',
  templateUrl: './rka-dpenjabaran.component.html',
  styleUrls: ['./rka-dpenjabaran.component.scss']
})
export class RkaDPenjabaranComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
  listdata: IRkadetd[] = [];
  ...
  @ViewChild(RkadetdFormComponent, { static: true }) Form: RkadetdFormComponent;
