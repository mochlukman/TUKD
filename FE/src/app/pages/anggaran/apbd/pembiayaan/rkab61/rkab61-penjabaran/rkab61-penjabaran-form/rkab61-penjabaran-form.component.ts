...
@Component({
  selector: 'app-rkab61-penjabaran-form',
  templateUrl: './rkab61-penjabaran-form.component.html',
  styleUrls: ['./rkab61-penjabaran-form.component.scss'],
  providers: [InputRupiahPipe]
})
export class Rkab61PenjabaranFormComponent implements OnInit {
