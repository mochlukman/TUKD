...
import { Rkab61PenjabaranFormComponent } from './rkab61-penjabaran-form/rkab61-penjabaran-form.component';

@Component({
  selector: 'app-rkab61-penjabaran',
  templateUrl: './rkab61-penjabaran.component.html',
  styleUrls: ['./rkab61-penjabaran.component.scss']
})
export class Rkab61PenjabaranComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: IRkadetb[] = [];
  ...
  @ViewChild(Rkab61PenjabaranFormComponent, { static: true }) Form: Rkab61PenjabaranFormComponent;
