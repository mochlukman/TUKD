...
import { Rkab61FormComponent } from './rkab61-form/rkab61-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-rkab61',
  templateUrl: './rkab61.component.html',
  styleUrls: ['./rkab61.component.scss'],
  providers: [InputRupiahPipe]
})
export class Rkab61Component implements OnInit, OnDestroy {
  ...
  @ViewChild(Rkab61FormComponent, { static: true }) Form: Rkab61FormComponent;
