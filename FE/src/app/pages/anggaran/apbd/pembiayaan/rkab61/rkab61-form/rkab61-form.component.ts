...
@Component({
  selector: 'app-rkab61-form',
  templateUrl: './rkab61-form.component.html',
  styleUrls: ['./rkab61-form.component.scss']
})
export class Rkab61FormComponent implements OnInit {
  ...
  lookRekening(){
    ...
    this.Daftrek._kdperStartwith = '6.1.'
