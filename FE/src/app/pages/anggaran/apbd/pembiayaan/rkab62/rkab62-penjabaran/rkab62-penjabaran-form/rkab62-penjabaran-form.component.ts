...
@Component({
  selector: 'app-rkab62-penjabaran-form',
  templateUrl: './rkab62-penjabaran-form.component.html',
  styleUrls: ['./rkab62-penjabaran-form.component.scss'],
  providers: [InputRupiahPipe]
})
export class Rkab62PenjabaranFormComponent implements OnInit {
