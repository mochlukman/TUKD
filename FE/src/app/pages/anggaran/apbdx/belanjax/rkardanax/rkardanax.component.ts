...
import { RkardanaFormxComponent } from './rkardana-formx/rkardana-formx.component';

@Component({
  selector: 'app-rkardanax',
  templateUrl: './rkardanax.component.html',
  styleUrls: ['./rkardanax.component.scss']
})
export class RkardanaxComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(RkardanaFormxComponent, {static: true}) Form : RkardanaFormxComponent;
  ...
  update(e: IRkadanar){
    ...
    this.Form.forms.patchValue({
      ...
      idjdana : e.idjdana,
      nilai :e.nilai,
      nilaix : e.Rkadanarx ? e.Rkadanarx.nilai : 0
    });
