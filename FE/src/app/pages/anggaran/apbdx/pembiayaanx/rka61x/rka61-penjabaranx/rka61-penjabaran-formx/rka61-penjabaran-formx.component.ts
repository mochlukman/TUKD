...
@Component({
  selector: 'app-rka61-penjabaran-formx',
  templateUrl: './rka61-penjabaran-formx.component.html',
  styleUrls: ['./rka61-penjabaran-formx.component.scss'],
  providers: [InputRupiahPipe]
})
export class Rka61PenjabaranFormxComponent implements OnInit {
