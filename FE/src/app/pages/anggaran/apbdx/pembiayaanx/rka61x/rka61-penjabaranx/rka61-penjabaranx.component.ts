...
import { Rka61PenjabaranFormxComponent } from './rka61-penjabaran-formx/rka61-penjabaran-formx.component';

@Component({
  selector: 'app-rka61-penjabaranx',
  templateUrl: './rka61-penjabaranx.component.html',
  styleUrls: ['./rka61-penjabaranx.component.scss']
})
export class Rka61PenjabaranxComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
  listdata: IRkadetb[] = [];
  ...
  @ViewChild(Rka61PenjabaranFormxComponent, { static: true }) Form: Rka61PenjabaranFormxComponent;
