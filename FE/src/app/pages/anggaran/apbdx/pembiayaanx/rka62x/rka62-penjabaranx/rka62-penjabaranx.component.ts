...
import { Rka62PenjabaranFormxComponent } from './rka62-penjabaran-formx/rka62-penjabaran-formx.component';

@Component({
  selector: 'app-rka62-penjabaranx',
  templateUrl: './rka62-penjabaranx.component.html',
  styleUrls: ['./rka62-penjabaranx.component.scss']
})
export class Rka62PenjabaranxComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: IRkadetb[] = [];
  ...
  @ViewChild(Rka62PenjabaranFormxComponent, { static: true }) Form: Rka62PenjabaranFormxComponent;
