...
import { Rka62FormxComponent } from './rka62-formx/rka62-formx.component';

@Component({
  selector: 'app-rka62x',
  templateUrl: './rka62x.component.html',
  styleUrls: ['./rka62x.component.scss'],
  providers: [InputRupiahPipe]
})
export class Rka62xComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(Rka62FormxComponent, { static: true }) Form: Rka62FormxComponent;
