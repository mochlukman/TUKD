...
import { TapddFormxComponent } from './tapdd-formx/tapdd-formx.component';

@Component({
  selector: 'app-tapddx',
  templateUrl: './tapddx.component.html',
  styleUrls: ['./tapddx.component.scss']
})
export class TapddxComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapddFormxComponent, {static: true}) Form : TapddFormxComponent;
  constructor(
