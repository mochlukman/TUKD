...
import { TapddetbxComponent } from '../tapddetbx/tapddetbx.component';

@Component({
  selector: 'app-rkadetbx',
  templateUrl: './rkadetbx.component.html',
  styleUrls: ['./rkadetbx.component.scss']
})
export class RkadetbxComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: IRkadetb[] = [];
  ...
  @ViewChild(TapddetbxComponent, {static: true}) Tapddet: TapddetbxComponent;
