...
import { TapddetrxComponent } from '../tapddetrx/tapddetrx.component';

@Component({
  selector: 'app-rkadetrx',
  templateUrl: './rkadetrx.component.html',
  styleUrls: ['./rkadetrx.component.scss']
})
export class RkadetrxComponent implements OnInit, OnDestroy {
  loading: boolean;
  listdata: IRkadetr[] = [];
  ...
  @ViewChild(TapddetrxComponent, {static: true}) Tapddet: TapddetrxComponent;
  totalNilai: number = 0;
  constructor(
