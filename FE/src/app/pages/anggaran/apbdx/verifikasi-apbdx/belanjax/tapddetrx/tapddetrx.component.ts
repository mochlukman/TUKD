...
import { TapddetrFormxComponent } from './tapddetr-formx/tapddetr-formx.component';

@Component({
  selector: 'app-tapddetrx',
  templateUrl: './tapddetrx.component.html',
  styleUrls: ['./tapddetrx.component.scss']
})
export class TapddetrxComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(TapddetrFormxComponent, {static: true}) Form : TapddetrFormxComponent;
  idunit: number = 0;
  constructor(
