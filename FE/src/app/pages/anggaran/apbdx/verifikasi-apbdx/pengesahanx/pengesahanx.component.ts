...
import { PengesahanFormxComponent } from './pengesahan-formx/pengesahan-formx.component';

@Component({
  selector: 'app-pengesahanx',
  templateUrl: './pengesahanx.component.html',
  styleUrls: ['./pengesahanx.component.scss']
})
export class PengesahanxComponent implements OnInit, OnDestroy {
  ...
  indexTab = 0;
  @ViewChild(PengesahanFormxComponent, {static: true}) Form: PengesahanFormxComponent;
  constructor(
