...
import { LookDaftrekForRkadCheckboxComponent } from 'src/app/shared/lookups/look-daftrek-for-rkad-checkbox/look-daftrek-for-rkad-checkbox.component';

@Component({
  selector: 'app-rkad-formx',
  templateUrl: './rkad-formx.component.html',
  styleUrls: ['./rkad-formx.component.scss']
})
export class RkadFormxComponent implements OnInit {
  ...
  @ViewChild(LookDaftrekForRkadCheckboxComponent, {static: true}) Daftrek : LookDaftrekForRkadCheckboxComponent;
