...
@Component({
  selector: 'app-kinkeg-sub-form',
  templateUrl: './kinkeg-sub-form.component.html',
  styleUrls: ['./kinkeg-sub-form.component.scss']
})
export class KinkegSubFormComponent implements OnInit {
