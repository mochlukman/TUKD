...
import { KinkegFormComponent } from './kinkeg-form/kinkeg-form.component';

@Component({
  selector: 'app-kinkeg',
  templateUrl: './kinkeg.component.html',
  styleUrls: ['./kinkeg.component.scss']
})
export class KinkegComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(KinkegFormComponent, { static: true }) Form: KinkegFormComponent;
