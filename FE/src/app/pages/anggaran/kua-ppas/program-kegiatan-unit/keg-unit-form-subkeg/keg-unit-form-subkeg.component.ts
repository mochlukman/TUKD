...
@Component({
  selector: 'app-keg-unit-form-subkeg',
  templateUrl: './keg-unit-form-subkeg.component.html',
  styleUrls: ['./keg-unit-form-subkeg.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class KegUnitFormSubkegComponent implements OnInit {
