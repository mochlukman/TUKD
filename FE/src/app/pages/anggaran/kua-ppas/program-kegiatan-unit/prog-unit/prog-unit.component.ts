...
import { ProgUnitFormComponent } from '../prog-unit-form/prog-unit-form.component';

@Component({
  selector: 'app-prog-unit',
  templateUrl: './prog-unit.component.html',
  styleUrls: ['./prog-unit.component.scss']
})
export class ProgUnitComponent implements OnInit, OnDestroy {
  title: string = '';
  ...
  @ViewChild(ProgUnitFormComponent, {static: true}) Form: ProgUnitFormComponent;
  ...
  constructor(
    ...
    this.formFilter = this.fb.group({
      ...
      kdtahap: ['321', Validators.required]
    });
