...
@Component({
  selector: 'app-keg-dana-form',
  templateUrl: './keg-dana-form.component.html',
  styleUrls: ['./keg-dana-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class KegDanaFormComponent implements OnInit {
