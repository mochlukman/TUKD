...
import { KegDanaFormComponent } from './keg-dana-form/keg-dana-form.component';

@Component({
  selector: 'app-keg-dana',
  templateUrl: './keg-dana.component.html',
  styleUrls: ['./keg-dana.component.scss']
})
export class KegDanaComponent implements OnInit {
  showThis: boolean;
  title: string = '';
  ...
  @ViewChild(KegDanaFormComponent, {static: true}) Form : KegDanaFormComponent;
