...
@Component({
  selector: 'app-keg-unit-formx',
  templateUrl: './keg-unit-formx.component.html',
  styleUrls: ['./keg-unit-formx.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class KegUnitFormxComponent implements OnInit {
