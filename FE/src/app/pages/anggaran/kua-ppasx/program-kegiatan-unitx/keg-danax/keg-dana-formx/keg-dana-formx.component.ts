...
@Component({
  selector: 'app-keg-dana-formx',
  templateUrl: './keg-dana-formx.component.html',
  styleUrls: ['./keg-dana-formx.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class KegDanaFormxComponent implements OnInit {
