...
import { KinkegSubFormxComponent } from './kinkeg-sub-formx/kinkeg-sub-formx.component';

@Component({
  selector: 'app-kinkeg-subx',
  templateUrl: './kinkeg-subx.component.html',
  styleUrls: ['./kinkeg-subx.component.scss']
})
export class KinkegSubxComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(KinkegSubFormxComponent, { static: true }) Form: KinkegSubFormxComponent;
