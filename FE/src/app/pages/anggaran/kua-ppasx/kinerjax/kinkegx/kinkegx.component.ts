...
import { KinkegFormxComponent } from './kinkeg-formx/kinkeg-formx.component';

@Component({
  selector: 'app-kinkegx',
  templateUrl: './kinkegx.component.html',
  styleUrls: ['./kinkegx.component.scss']
})
export class KinkegxComponent implements OnInit, OnDestroy {
  ...
  @ViewChild(KinkegFormxComponent, { static: true }) Form: KinkegFormxComponent;
  ...
  add() {
    if (this.formFilter.valid) {
      this.Form.title = 'Tambah Kinerja Kegiatan';
      this.Form.mode = 'add';
  ...
  edit(e: IKinkeg) {
    this.Form.forms.patchValue({
      ...
      tolokur: e.tolokur,
      target: e.target,
      targetx : e.kinkegx ? e.kinkegx.target : 0,
      satuan: e.satuan,
      keterangan: e.keterangan,
    });
    this.Form.title = 'Ubah Kinerja Kegiatan';
    this.Form.mode = 'edit';
    this.Form.showThis = true;
  }
  delete(e: IKinkeg) {
