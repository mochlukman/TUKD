...
@Component({
  selector: 'app-kinkeg-formx',
  templateUrl: './kinkeg-formx.component.html',
  styleUrls: ['./kinkeg-formx.component.scss']
})
export class KinkegFormxComponent implements OnInit {
