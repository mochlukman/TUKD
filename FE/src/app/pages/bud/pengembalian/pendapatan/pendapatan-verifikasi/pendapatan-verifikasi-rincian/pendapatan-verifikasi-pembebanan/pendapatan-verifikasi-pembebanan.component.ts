...
@Component({
  selector: 'app-pendapatan-verifikasi-pembebanan',
  templateUrl: './pendapatan-verifikasi-pembebanan.component.html',
  styleUrls: ['./pendapatan-verifikasi-pembebanan.component.scss']
})
export class PendapatanVerifikasiPembebananComponent implements OnInit, OnChanges, OnDestroy {
  loading: boolean;
  listdata: Ispmdetd[] = [];
