...
import { PendapatanVerifikasiFormComponent } from './pendapatan-verifikasi-form/pendapatan-verifikasi-form.component';

@Component({
  selector: 'app-pendapatan-verifikasi',
  templateUrl: './pendapatan-verifikasi.component.html',
  styleUrls: ['./pendapatan-verifikasi.component.scss']
})
export class PendapatanVerifikasiComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(PendapatanVerifikasiFormComponent, {static: true}) Form : PendapatanVerifikasiFormComponent;
  ...
  add(){
    if(this.unitSelected){
      ...
      this.Form.title = 'Tambah SP2D Penerimaan Pendapatan';
      this.Form.mode = 'add';
