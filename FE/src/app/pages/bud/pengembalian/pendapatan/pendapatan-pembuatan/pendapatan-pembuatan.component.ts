...
import { PendapatanPembuatanFormComponent } from './pendapatan-pembuatan-form/pendapatan-pembuatan-form.component';

@Component({
  selector: 'app-pendapatan-pembuatan',
  templateUrl: './pendapatan-pembuatan.component.html',
  styleUrls: ['./pendapatan-pembuatan.component.scss']
})
export class PendapatanPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PendapatanPembuatanFormComponent, {static: true}) Form : PendapatanPembuatanFormComponent;
  ...
  add(){
    if(this.unitSelected){
      ...
      this.Form.title = 'Tambah SP2D Pendapatan';
      this.Form.mode = 'add';
