...
@Component({
  selector: 'app-pendapatan-pembuatan-rincian',
  templateUrl: './pendapatan-pembuatan-rincian.component.html',
  styleUrls: ['./pendapatan-pembuatan-rincian.component.scss']
})
export class PendapatanPembuatanRincianComponent implements OnInit {
  tabIndex: number = 0;
