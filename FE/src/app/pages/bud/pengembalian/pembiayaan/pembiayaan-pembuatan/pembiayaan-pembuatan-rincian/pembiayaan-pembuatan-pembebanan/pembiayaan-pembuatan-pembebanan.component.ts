...
@Component({
  selector: 'app-pembiayaan-pembuatan-pembebanan',
  templateUrl: './pembiayaan-pembuatan-pembebanan.component.html',
  styleUrls: ['./pembiayaan-pembuatan-pembebanan.component.scss']
})
export class PembiayaanPembuatanPembebananComponent implements OnInit, OnDestroy, OnChanges {
  loading: boolean;
  listdata: Ispmdetb[] = [];
