...
import { PembiayaanVerifikasiFormComponent } from './pembiayaan-verifikasi-form/pembiayaan-verifikasi-form.component';

@Component({
  selector: 'app-pembiayaan-verifikasi',
  templateUrl: './pembiayaan-verifikasi.component.html',
  styleUrls: ['./pembiayaan-verifikasi.component.scss']
})
export class PembiayaanVerifikasiComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(PembiayaanVerifikasiFormComponent, {static: true}) Form : PembiayaanVerifikasiFormComponent;
