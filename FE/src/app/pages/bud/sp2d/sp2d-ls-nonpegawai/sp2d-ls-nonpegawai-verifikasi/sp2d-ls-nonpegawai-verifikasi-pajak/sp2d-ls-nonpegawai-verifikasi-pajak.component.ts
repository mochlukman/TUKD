...
@Component({
  selector: 'app-sp2d-ls-nonpegawai-verifikasi-pajak',
  templateUrl: './sp2d-ls-nonpegawai-verifikasi-pajak.component.html',
  styleUrls: ['./sp2d-ls-nonpegawai-verifikasi-pajak.component.scss']
})
export class Sp2dLsNonpegawaiVerifikasiPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
