...
@Component({
  selector: 'app-sp2d-ls-nonpegawai-verifikasi-detail-pembebanan',
  templateUrl: './sp2d-ls-nonpegawai-verifikasi-detail-pembebanan.component.html',
  styleUrls: ['./sp2d-ls-nonpegawai-verifikasi-detail-pembebanan.component.scss']
})
export class Sp2dLsNonpegawaiVerifikasiDetailPembebananComponent implements OnInit, OnChanges, OnDestroy {
