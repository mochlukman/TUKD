...
import { Sp2dLsNonpegawaiFormComponent } from '../sp2d-ls-nonpegawai-form/sp2d-ls-nonpegawai-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-sp2d-ls-nonpegawai-pembuatan',
  templateUrl: './sp2d-ls-nonpegawai-pembuatan.component.html',
  styleUrls: ['./sp2d-ls-nonpegawai-pembuatan.component.scss']
})
export class Sp2dLsNonpegawaiPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(Sp2dLsNonpegawaiFormComponent, {static: true}) Form : Sp2dLsNonpegawaiFormComponent;
