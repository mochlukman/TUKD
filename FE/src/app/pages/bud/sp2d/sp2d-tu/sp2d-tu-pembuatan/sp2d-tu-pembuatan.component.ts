...
import { Sp2dTuFormComponent } from '../sp2d-tu-form/sp2d-tu-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';


@Component({
  selector: 'app-sp2d-tu-pembuatan',
  templateUrl: './sp2d-tu-pembuatan.component.html',
  styleUrls: ['./sp2d-tu-pembuatan.component.scss']
})
export class Sp2dTuPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(Sp2dTuFormComponent, {static: true}) Form : Sp2dTuFormComponent;
