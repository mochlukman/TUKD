...
@Component({
  selector: 'app-sp2d-tu-form',
  templateUrl: './sp2d-tu-form.component.html',
  styleUrls: ['./sp2d-tu-form.component.scss']
})
export class Sp2dTuFormComponent implements OnInit {
