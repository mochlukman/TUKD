...
@Component({
  selector: 'app-sp2d-tu-verifikasi-check',
  templateUrl: './sp2d-tu-verifikasi-check.component.html',
  styleUrls: ['./sp2d-tu-verifikasi-check.component.scss']
})
export class Sp2dTuVerifikasiCheckComponent implements OnInit {
