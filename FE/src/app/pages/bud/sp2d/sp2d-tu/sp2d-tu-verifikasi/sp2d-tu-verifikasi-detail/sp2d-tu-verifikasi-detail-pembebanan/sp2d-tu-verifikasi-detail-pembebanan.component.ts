...
@Component({
  selector: 'app-sp2d-tu-verifikasi-detail-pembebanan',
  templateUrl: './sp2d-tu-verifikasi-detail-pembebanan.component.html',
  styleUrls: ['./sp2d-tu-verifikasi-detail-pembebanan.component.scss']
})
export class Sp2dTuVerifikasiDetailPembebananComponent implements OnInit, OnChanges, OnDestroy {
