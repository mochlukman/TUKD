...
@Component({
  selector: 'app-sp2d-tu-verifikasi-form',
  templateUrl: './sp2d-tu-verifikasi-form.component.html',
  styleUrls: ['./sp2d-tu-verifikasi-form.component.scss']
})
export class Sp2dTuVerifikasiFormComponent implements OnInit {
