...
@Component({
  selector: 'app-sp2d-upverifikasi-check',
  templateUrl: './sp2d-upverifikasi-check.component.html',
  styleUrls: ['./sp2d-upverifikasi-check.component.scss']
})
export class Sp2dUpverifikasiCheckComponent implements OnInit {
