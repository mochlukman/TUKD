...
@Component({
  selector: 'app-sp2d-upverifikasi-form',
  templateUrl: './sp2d-upverifikasi-form.component.html',
  styleUrls: ['./sp2d-upverifikasi-form.component.scss']
})
export class Sp2dUpverifikasiFormComponent implements OnInit {
