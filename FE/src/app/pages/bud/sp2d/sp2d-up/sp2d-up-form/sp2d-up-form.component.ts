...
@Component({
  selector: 'app-sp2d-up-form',
  templateUrl: './sp2d-up-form.component.html',
  styleUrls: ['./sp2d-up-form.component.scss']
})
export class Sp2dUpFormComponent implements OnInit {
  ...
  callbackSpm(e: ISpm){
    ...
    this.forms.patchValue({
      ...
      nilaiup: new Intl.NumberFormat('ID').format(this.spmSelected.idsppNavigation.nilaiup)
