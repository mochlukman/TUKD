...
import { Sp2dUpFormComponent } from '../sp2d-up-form/sp2d-up-form.component';

@Component({
  selector: 'app-sp2d-up-pembuatan',
  templateUrl: './sp2d-up-pembuatan.component.html',
  styleUrls: ['./sp2d-up-pembuatan.component.scss']
})
export class Sp2dUpPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(Sp2dUpFormComponent, {static: true}) Form : Sp2dUpFormComponent;
