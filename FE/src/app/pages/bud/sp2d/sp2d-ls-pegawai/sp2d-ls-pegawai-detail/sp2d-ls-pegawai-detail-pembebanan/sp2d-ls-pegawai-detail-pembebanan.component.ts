...
@Component({
  selector: 'app-sp2d-ls-pegawai-detail-pembebanan',
  templateUrl: './sp2d-ls-pegawai-detail-pembebanan.component.html',
  styleUrls: ['./sp2d-ls-pegawai-detail-pembebanan.component.scss']
})
export class Sp2dLsPegawaiDetailPembebananComponent implements OnInit, OnDestroy, OnChanges {
