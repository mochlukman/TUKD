...
@Component({
  selector: 'app-sp2d-ls-pegawai-pajak',
  templateUrl: './sp2d-ls-pegawai-pajak.component.html',
  styleUrls: ['./sp2d-ls-pegawai-pajak.component.scss']
})
export class Sp2dLsPegawaiPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
