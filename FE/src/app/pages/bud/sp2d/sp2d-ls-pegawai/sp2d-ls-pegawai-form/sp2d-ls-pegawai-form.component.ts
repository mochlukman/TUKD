...
@Component({
  selector: 'app-sp2d-ls-pegawai-form',
  templateUrl: './sp2d-ls-pegawai-form.component.html',
  styleUrls: ['./sp2d-ls-pegawai-form.component.scss']
})
export class Sp2dLsPegawaiFormComponent implements OnInit {
