...
@Component({
  selector: 'app-sp2d-ls-pegawai-verifikasi-pajak',
  templateUrl: './sp2d-ls-pegawai-verifikasi-pajak.component.html',
  styleUrls: ['./sp2d-ls-pegawai-verifikasi-pajak.component.scss']
})
export class Sp2dLsPegawaiVerifikasiPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
