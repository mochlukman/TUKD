...
@Component({
  selector: 'app-sp2d-ls-pegawai-verifikasi-check',
  templateUrl: './sp2d-ls-pegawai-verifikasi-check.component.html',
  styleUrls: ['./sp2d-ls-pegawai-verifikasi-check.component.scss']
})
export class Sp2dLsPegawaiVerifikasiCheckComponent implements OnInit {
