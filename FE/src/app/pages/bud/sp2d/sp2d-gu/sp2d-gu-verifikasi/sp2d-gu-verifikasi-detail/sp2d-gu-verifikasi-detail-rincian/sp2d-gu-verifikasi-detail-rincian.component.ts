...
@Component({
  selector: 'app-sp2d-gu-verifikasi-detail-rincian',
  templateUrl: './sp2d-gu-verifikasi-detail-rincian.component.html',
  styleUrls: ['./sp2d-gu-verifikasi-detail-rincian.component.scss']
})
export class Sp2dGuVerifikasiDetailRincianComponent implements OnInit, OnChanges, OnDestroy {
