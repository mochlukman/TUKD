...
@Component({
  selector: 'app-sp2d-gu-verifikasi-check',
  templateUrl: './sp2d-gu-verifikasi-check.component.html',
  styleUrls: ['./sp2d-gu-verifikasi-check.component.scss']
})
export class Sp2dGuVerifikasiCheckComponent implements OnInit {
