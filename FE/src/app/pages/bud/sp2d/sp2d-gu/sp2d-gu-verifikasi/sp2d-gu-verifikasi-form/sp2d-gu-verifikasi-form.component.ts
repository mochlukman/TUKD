...
@Component({
  selector: 'app-sp2d-gu-verifikasi-form',
  templateUrl: './sp2d-gu-verifikasi-form.component.html',
  styleUrls: ['./sp2d-gu-verifikasi-form.component.scss']
})
export class Sp2dGuVerifikasiFormComponent implements OnInit {
