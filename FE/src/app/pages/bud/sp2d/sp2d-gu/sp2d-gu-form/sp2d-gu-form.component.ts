...
@Component({
  selector: 'app-sp2d-gu-form',
  templateUrl: './sp2d-gu-form.component.html',
  styleUrls: ['./sp2d-gu-form.component.scss']
})
export class Sp2dGuFormComponent implements OnInit {
