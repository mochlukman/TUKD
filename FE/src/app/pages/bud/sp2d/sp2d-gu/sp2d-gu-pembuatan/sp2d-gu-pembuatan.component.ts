...
import { Sp2dGuFormComponent } from '../sp2d-gu-form/sp2d-gu-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-sp2d-gu-pembuatan',
  templateUrl: './sp2d-gu-pembuatan.component.html',
  styleUrls: ['./sp2d-gu-pembuatan.component.scss']
})
export class Sp2dGuPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(Sp2dGuFormComponent, {static: true}) Form : Sp2dGuFormComponent;
