...
@Component({
  selector: 'app-sp2d-ls-uangmuka-pajak',
  templateUrl: './sp2d-ls-uangmuka-pajak.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-pajak.component.scss']
})
export class Sp2dLsUangmukaPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
