...
@Component({
  selector: 'app-sp2d-ls-uangmuka-verifikasi-pajak',
  templateUrl: './sp2d-ls-uangmuka-verifikasi-pajak.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-verifikasi-pajak.component.scss']
})
export class Sp2dLsUangmukaVerifikasiPajakComponent implements OnInit, OnDestroy {
  tabIndex: number = 0;
