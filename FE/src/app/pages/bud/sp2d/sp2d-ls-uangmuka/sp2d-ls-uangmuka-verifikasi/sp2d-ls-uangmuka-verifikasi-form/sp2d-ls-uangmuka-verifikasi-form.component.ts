...
@Component({
  selector: 'app-sp2d-ls-uangmuka-verifikasi-form',
  templateUrl: './sp2d-ls-uangmuka-verifikasi-form.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-verifikasi-form.component.scss']
})
export class Sp2dLsUangmukaVerifikasiFormComponent implements OnInit {
