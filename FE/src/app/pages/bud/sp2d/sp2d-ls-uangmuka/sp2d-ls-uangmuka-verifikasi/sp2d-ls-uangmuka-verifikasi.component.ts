...
import { Sp2dLsUangmukaVerifikasiCheckComponent } from './sp2d-ls-uangmuka-verifikasi-check/sp2d-ls-uangmuka-verifikasi-check.component';
import { Sp2dLsUangmukaVerifikasiFormComponent } from './sp2d-ls-uangmuka-verifikasi-form/sp2d-ls-uangmuka-verifikasi-form.component';

@Component({
  selector: 'app-sp2d-ls-uangmuka-verifikasi',
  templateUrl: './sp2d-ls-uangmuka-verifikasi.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-verifikasi.component.scss']
})
export class Sp2dLsUangmukaVerifikasiComponent implements OnInit, OnChanges, OnDestroy {
  ...
  @ViewChild(Sp2dLsUangmukaVerifikasiFormComponent, {static: true}) Form : Sp2dLsUangmukaVerifikasiFormComponent;
  @ViewChild(Sp2dLsUangmukaVerifikasiCheckComponent, {static: true}) Checks: Sp2dLsUangmukaVerifikasiCheckComponent;
