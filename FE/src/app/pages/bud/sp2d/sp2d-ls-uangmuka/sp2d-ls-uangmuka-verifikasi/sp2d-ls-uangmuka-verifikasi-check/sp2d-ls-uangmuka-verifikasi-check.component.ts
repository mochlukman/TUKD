...
@Component({
  selector: 'app-sp2d-ls-uangmuka-verifikasi-check',
  templateUrl: './sp2d-ls-uangmuka-verifikasi-check.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-verifikasi-check.component.scss']
})
export class Sp2dLsUangmukaVerifikasiCheckComponent implements OnInit {
