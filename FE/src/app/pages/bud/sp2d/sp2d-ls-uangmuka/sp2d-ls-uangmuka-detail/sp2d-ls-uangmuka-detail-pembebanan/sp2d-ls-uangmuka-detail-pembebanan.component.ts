...
@Component({
  selector: 'app-sp2d-ls-uangmuka-detail-pembebanan',
  templateUrl: './sp2d-ls-uangmuka-detail-pembebanan.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-detail-pembebanan.component.scss']
})
export class Sp2dLsUangmukaDetailPembebananComponent implements OnInit, OnDestroy, OnChanges {
