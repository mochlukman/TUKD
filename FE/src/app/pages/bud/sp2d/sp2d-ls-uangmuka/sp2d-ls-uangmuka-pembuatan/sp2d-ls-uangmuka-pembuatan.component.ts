...
import { Sp2dLsUangmukaFormComponent } from '../sp2d-ls-uangmuka-form/sp2d-ls-uangmuka-form.component';
import { ReportModalComponent } from 'src/app/shared/modals/report-modal/report-modal.component';
import { ReportService } from 'src/app/core/services/report.service';

@Component({
  selector: 'app-sp2d-ls-uangmuka-pembuatan',
  templateUrl: './sp2d-ls-uangmuka-pembuatan.component.html',
  styleUrls: ['./sp2d-ls-uangmuka-pembuatan.component.scss']
})
export class Sp2dLsUangmukaPembuatanComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(Sp2dLsUangmukaFormComponent, {static: true}) Form : Sp2dLsUangmukaFormComponent;
