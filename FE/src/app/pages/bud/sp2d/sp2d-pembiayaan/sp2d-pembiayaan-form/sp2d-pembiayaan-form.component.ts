...
@Component({
  selector: 'app-sp2d-pembiayaan-form',
  templateUrl: './sp2d-pembiayaan-form.component.html',
  styleUrls: ['./sp2d-pembiayaan-form.component.scss']
})
export class Sp2dPembiayaanFormComponent implements OnInit {
