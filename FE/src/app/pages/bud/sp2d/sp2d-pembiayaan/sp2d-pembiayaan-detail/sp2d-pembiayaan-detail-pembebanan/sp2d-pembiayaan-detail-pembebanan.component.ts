...
@Component({
  selector: 'app-sp2d-pembiayaan-detail-pembebanan',
  templateUrl: './sp2d-pembiayaan-detail-pembebanan.component.html',
  styleUrls: ['./sp2d-pembiayaan-detail-pembebanan.component.scss']
})
export class Sp2dPembiayaanDetailPembebananComponent implements OnInit, OnDestroy, OnChanges {
