...
@Component({
  selector: 'app-sp2d-pembiayaan-verifikasi-check',
  templateUrl: './sp2d-pembiayaan-verifikasi-check.component.html',
  styleUrls: ['./sp2d-pembiayaan-verifikasi-check.component.scss']
})
export class Sp2dPembiayaanVerifikasiCheckComponent implements OnInit {
