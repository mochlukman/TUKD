...
@Component({
  selector: 'app-sp2d-pembiayaan-verifikasi-form',
  templateUrl: './sp2d-pembiayaan-verifikasi-form.component.html',
  styleUrls: ['./sp2d-pembiayaan-verifikasi-form.component.scss']
})
export class Sp2dPembiayaanVerifikasiFormComponent implements OnInit {
