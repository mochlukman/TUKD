...
@Component({
  selector: 'app-detail-tu-pembebanan-pengesahan',
  templateUrl: './detail-tu-pembebanan-pengesahan.component.html',
  styleUrls: ['./detail-tu-pembebanan-pengesahan.component.scss']
})
export class DetailTuPembebananPengesahanComponent implements OnInit, OnChanges, OnDestroy {
