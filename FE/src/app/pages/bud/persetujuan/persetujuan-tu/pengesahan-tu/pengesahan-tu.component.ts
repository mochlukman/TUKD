...
import { PengesahanTuCheckComponent } from './pengesahan-tu-check/pengesahan-tu-check.component';
import { PengesahanTuFormComponent } from './pengesahan-tu-form/pengesahan-tu-form.component';

@Component({
  selector: 'app-pengesahan-tu',
  templateUrl: './pengesahan-tu.component.html',
  styleUrls: ['./pengesahan-tu.component.scss']
})
export class PengesahanTuComponent implements OnInit, OnDestroy, OnChanges {
  ...
  @ViewChild(PengesahanTuFormComponent, {static: true}) Form : PengesahanTuFormComponent;
  @ViewChild(PengesahanTuCheckComponent, {static: true}) Checks: PengesahanTuCheckComponent;
