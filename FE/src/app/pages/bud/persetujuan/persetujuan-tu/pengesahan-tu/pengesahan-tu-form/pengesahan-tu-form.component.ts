...
@Component({
  selector: 'app-pengesahan-tu-form',
  templateUrl: './pengesahan-tu-form.component.html',
  styleUrls: ['./pengesahan-tu-form.component.scss'],
  providers: [ InputRupiahPipe ]
})
export class PengesahanTuFormComponent implements OnInit {
