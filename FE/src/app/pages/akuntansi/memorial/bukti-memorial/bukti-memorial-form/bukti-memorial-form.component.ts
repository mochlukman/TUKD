...
@Component({
  selector: 'app-bukti-memorial-form',
  templateUrl: './bukti-memorial-form.component.html',
  styleUrls: ['./bukti-memorial-form.component.scss']
})
export class BuktiMemorialFormComponent implements OnInit {
  showthis: boolean;
  loadingpost: boolean;
  title: string;
  mode: string;
