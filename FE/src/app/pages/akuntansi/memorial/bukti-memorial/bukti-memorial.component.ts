...
@Component({
  selector: 'app-bukti-memorial',
  templateUrl: './bukti-memorial.component.html',
  styleUrls: ['./bukti-memorial.component.scss']
})
export class BuktiMemorialComponent implements OnInit, OnDestroy {
  title: string;
  ...
  @ViewChild(BuktiMemorialFormComponent,{static: true}) Form: BuktiMemorialFormComponent;
  ...
  print(data: any){}
  add(){
    this.Form.title = 'Tambah Bukti Memorial';
    this.Form.mode = 'add';
  ...
  update(data: any){
    this.Form.title = 'Ubah Bukti Memorial';
    this.Form.mode = 'edit';
    this.Form.forms.patchValue({
      idbm : data.idbm,
      idunit : data.idunit,
