...
@Component({
  selector: 'app-lra-rincian',
  templateUrl: './lra-rincian.component.html',
  styleUrls: ['./lra-rincian.component.scss']
})
export class LraRincianComponent implements OnInit, OnDestroy, OnChanges {
