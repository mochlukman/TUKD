...
@Component({
  selector: 'app-lo-rincian',
  templateUrl: './lo-rincian.component.html',
  styleUrls: ['./lo-rincian.component.scss']
})
export class LoRincianComponent implements OnInit, OnChanges, OnDestroy {
