...
@Component({
  selector: 'app-surflus',
  templateUrl: './surflus.component.html',
  styleUrls: ['./surflus.component.scss']
})
export class SurflusComponent implements OnInit, OnDestroy {
  title: string;
  ...
  @ViewChild(SurflusFormComponent,{static: true}) Form: SurflusFormComponent;
